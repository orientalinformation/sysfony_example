...
*/
! function(a) {
  a.jqx.jqxWidget("jqxChart", "", {}), a.extend(a.jqx._jqxChart.prototype, {
    defineInstance: function() {
      return a.extend(!0, this, this._defaultSettings), this._createColorsCache(), this._defaultSettings
    },
    _defaultSettings: {
      title: "Title",
    ...
    createInstance: function(b) {
      if (!a.jqx.dataAdapter) throw "jqxdata.js is not loaded";
      var c = this;
      c._refreshOnDownloadComlete(), c._isTouchDevice = a.jqx.mobile.isTouchDevice(), c._jqxPlot || (c._jqxPlot = new jqxPlot), c.addHandler(c.host, c._getEvent("mousemove"), function(b) {
        if (0 != c.enabled) {
          ...
          d -= f.left, e -= f.top, c.onmousemove(d, e)
        }
        ...
        if (0 != c.enabled) {
          var b = c._mouseX,
            d = c._mouseY,
            e = c._plotRect;
          e && b >= e.x && b <= e.x + e.width && d >= e.y && d <= e.y + e.height || (c._cancelTooltipTimer(), c._hideToolTip(0), c._unselect())
        }
        ...
        if (0 != c.enabled) {
          ...
          d -= f.left, e -= f.top, c._mouseX = d, c._mouseY = e, !isNaN(c._lastClickTs) && (new Date).valueOf() - c._lastClickTs < 100 || (this._hostClickTimer = setTimeout(function() {
            if (c._isTouchDevice || (c._cancelTooltipTimer(), c._hideToolTip(), c._unselect()), c._pointMarker && c._pointMarker.element) {
              var a = c.seriesGroups[c._pointMarker.gidx],
                d = a.series[c._pointMarker.sidx];
              b.stopImmediatePropagation(), c._raiseItemEvent("click", a, d, c._pointMarker.iidx)
            }
          }, 100))
        }
      });
      ...
      if (d) {
        var e = !1;
        null != d.width && (e |= -1 != d.width.toString().indexOf("%")), null != d.height && (e |= -1 != d.height.toString().indexOf("%")), e && a.jqx.utilities.resize(this.host, function() {
          c.timer && clearTimeout(c.timer);
          c.timer = setTimeout(function() {
            var a = c.enableAnimations;
            c.enableAnimations = !1, c.refresh(), c.enableAnimations = a
          }, 1)
        }, !1, !0)
      }
    },
    _refreshOnDownloadComlete: function() {
      ...
      if (c instanceof a.jqx.dataAdapter) {
        var d = c._options;
        (void 0 == d || void 0 != d && !d.autoBind) && (c.autoSync = !1, c.dataBind());
        var e = this.element.id;
        if (0 == c.records.length) {
          var f = function() {
            b.ready && b.ready(), b.refresh()
          };
          c.unbindDownloadComplete(e), c.bindDownloadComplete(e, f)
        } else b.ready && b.ready();
        c.unbindBindingUpdate(e), c.bindBindingUpdate(e, function() {
          b._supressBindingRefresh || b.refresh()
        })
      }
    },
    propertyChangedHandler: function(a, b, c, d) {
      void 0 != this.isInitialized && 0 != this.isInitialized && ("source" == b && this._refreshOnDownloadComlete(), this.refresh())
    },
    _initRenderer: function(b) {
      if (!a.jqx.createRenderer) throw "Please include jqxdraw.js";
      return a.jqx.createRenderer(this, b)
    },
    _internalRefresh: function() {
      var b = this;
      if (!a.jqx.isHidden(b.host)) {
        b._stopAnimations(), b.renderer && (b._isToggleRefresh || b._isUpdate) || (b._hideToolTip(0), b._isVML = !1, b.host.empty(), b._measureDiv = void 0, b._initRenderer(b.host));
        var c = b.renderer;
        if (c) {
          var d = c.getRect();
          b._render({
            ...
            instance: this
          }), c instanceof a.jqx.HTML5Renderer && c.refresh(), b._isUpdate = !1, this._raiseEvent("refreshEnd", {
            instance: this
          })
        }
      }
        ...
        if (f && f.rangeSelector && !f.rangeSelector.renderTo) {
          ...
          if (g) {
            var h = g.jqxChart("getInstance"),
              i = (h.renderEngine, h.renderer.getRect()),
              ...
              q = m ? "x" : "y",
              r = {};
            r[p] = l.startOffset + l.rect[p], r[q] = l.rect[q], r[n] = l.endOffset - l.startOffset, r[o] = l.rect[o];
            var s = f.rangeSelector.colorSelectedRange || "blue",
              t = (f.rangeSelector.colorUnselectedRange, f.rangeSelector.colorRangeLine || "grey"),
              u = [];
            ...
            for (var w = 0; w < u.length; w++) h.renderer.removeElement(u[w]);
            h.renderer.refresh()
          }
        }
      }
    ...
    update: function() {
      this._isUpdate = !0, this._internalRefresh()
    },
    ...
    clear: function() {
      var a = this;
      for (var b in a._defaultSettings) a[b] = a._defaultSettings[b];
      a.title = "", a.description = "", a.refresh()
    },
    _validateSeriesGroups: function() {
      if (!a.isArray(this.seriesGroups)) throw "Invalid property: 'seriesGroups' property is required and must be a valid array.";
      for (var b = 0; b < this.seriesGroups.length; b++) {
        var c = this.seriesGroups[b];
        if (!c.type) throw "Invalid property: Each series group must have a valid 'type' property.";
        if (!a.isArray(c.series)) throw "Invalid property: Each series group must have a 'series' property which must be a valid array."
      }
    },
    _render: function(b) {
      var c = this,
        d = c.renderer;
      c._validateSeriesGroups(), c._colorsCache.clear(), !c._isToggleRefresh && c._isUpdate && c._renderData && c._renderDataClone(), c._renderData = [], d.clear(), c._unselect(), c._hideToolTip(0);
      ...
      if (void 0 == e || "" == e ? d.attr(i, {
        ...
        (isNaN(k) || k < 0 || k > 10) && (k = 1), d.attr(i, {
          "stroke-width": k,
          stroke: j
        })
      } else a.jqx.browser.msie && a.jqx.browser.version < 9 && d.attr(i, {
        "stroke-width": 1,
      ...
      if (c.title && c.title.length > 0) {
        ...
        m = d.measureText(c.title, 0, {
          ...
          class: o
        }, !0, "center", "center"), l.y += m.height, l.height -= m.height
      }
      ...
      }(c.title || c.description) && (l.y += n.bottom + n.top, l.height -= n.bottom + n.top);
      var q = {
        x: l.x,
        y: l.y,
        width: l.width,
      ...
      for (var r, s = c._isPieOnlySeries(), t = c.seriesGroups, u = {
        ...
        if ("pie" != t[v].type && "donut" != t[v].type) {
          var w = c._getXAxis(v);
          if (!w) throw "seriesGroup[" + v + "] is missing xAxis definition";
      ...
      for (v = 0; v < t.length; v++) {
        ...
        if ("pie" != B.type && "donut" != B.type && 1 != B.spider && 1 != B.polar) {
          ...
          E && "auto" != E || (r ? (E = this._renderXAxis(v, F, !0, q).width, 1 == (1 & u.xAxis[x]) ? E = 0 : E > 0 && (u.xAxis[x] |= 1)) : (E = c._renderValueAxis(v, F, !0, q).width, 1 == (1 & u.valueAxis[D]) ? E = 0 : E > 0 && (u.valueAxis[D] |= 1))), "left" != G && 1 == c.rtl && (G = "right"), "right" != G && (G = "left"), z[G + "Count"] > 0 && z[G] > 0 && E > 0 && (z[G] += y), A.push({
            width: E,
            position: G,
            xRel: z[G]
          }), z[G] += E, z[G + "Count"]++
      ...
      for (v = 0; v < t.length; v++) {
        ...
        if ("pie" != B.type && "donut" != B.type && 1 != B.spider && 1 != B.polar) {
          ...
          K && "auto" != K || (r ? (K = c._renderValueAxis(v, {
            ...
            width: H,
            height: 0
          }, !0, q).height, 2 == (2 & u.valueAxis[D]) ? K = 0 : K > 0 && (u.valueAxis[D] |= 2)) : (K = c._renderXAxis(v, {
            x: 0,
            y: 0,
            width: H,
            height: 0
          }, !0).height, 2 == (2 & u.xAxis[x]) ? K = 0 : K > 0 && (u.xAxis[x] |= 2))), "top" != G && (G = "bottom"), I[G + "Count"] > 0 && I[G] > 0 && K > 0 && (I[G] += y), J.push({
            height: K,
            position: G,
            yRel: I[G]
          }), I[G] += K, I[G + "Count"]++
      ...
      if (!this.legendLayout || isNaN(this.legendLayout.left) && isNaN(this.legendLayout.top) || (M = {
          width: 0,
          height: 0
        }), l.height < I.top + I.bottom + M.height || l.width < z.left + z.right) return void d.endGroup();
      q.height -= I.top + I.bottom + M.height, q.x += z.left, q.width -= z.left + z.right, q.y += I.top;
      var N = [];
      if (!s) {
        ...
        for (v = 0; v < t.length; v++) {
          ...
          if (1 != B.polar && 1 != B.spider && "pie" != B.type && "donut" != B.type) {
            ...
            if ("top" != J[v].position ? F.y = q.y + q.height + J[v].yRel : F.y = q.y - J[v].yRel - J[v].height, r) {
              if (4 == (4 & u.valueAxis[D])) continue;
              if (!c._isGroupVisible(v)) continue;
              c._renderValueAxis(v, F, !1, q), u.valueAxis[D] |= 4
            } else {
              if (N.push(F), 4 == (4 & u.xAxis[x])) continue;
              if (!c._isGroupVisible(v)) continue;
              c._renderXAxis(v, F, !1, q), u.xAxis[x] |= 4
            }
          }
        }
      }
      if (L) {
        var O = c.legendLayout ? c._rect : l,
          ...
          E = l.width,
          K = M.height;
        c.legendLayout && (isNaN(c.legendLayout.left) || (P = c.legendLayout.left), isNaN(c.legendLayout.top) || (Q = c.legendLayout.top), isNaN(c.legendLayout.width) || (E = c.legendLayout.width), isNaN(c.legendLayout.height) || (K = c.legendLayout.height)), P + E > O.x + O.width && (E = O.x + O.width - P), Q + K > O.y + O.height && (K = O.y + O.height - Q), c._renderLegend({
          x: P,
          y: Q,
          width: E,
          height: K
        ...
        for (v = 0; v < t.length; v++) {
          ...
          if (1 != B.polar && 1 != B.spider && "pie" != B.type && "donut" != B.type) {
            ...
            var x = c._getXAxis(v) == c._getXAxis() ? -1 : v,
              D = c._getValueAxis(v) == c._getValueAxis() ? -1 : v;
            if (r) {
              if (N.push(F), 8 == (8 & u.xAxis[x])) continue;
              if (!c._isGroupVisible(v)) continue;
              c._renderXAxis(v, F, !1, q), u.xAxis[x] |= 8
            } else {
              if (8 == (8 & u.valueAxis[D])) continue;
              if (!c._isGroupVisible(v)) continue;
              c._renderValueAxis(v, F, !1, q), u.valueAxis[D] |= 8
            }
          }
        }
      if (!(q.width <= 0 || q.height <= 0)) {
        for (c._plotRect = {
            ...
            width: q.width,
            height: q.height
          }, v = 0; v < t.length; v++) this._drawPlotAreaLines(v, !0, {
          gridLines: !1,
          tickMarks: !1,
        ...
        for (v = 0; v < t.length; v++) this._drawPlotAreaLines(v, !0, {
          gridLines: !0,
          tickMarks: !0,
        ...
        for (v = 0; v < t.length; v++) {
          ...
          if (!U) throw 'Invalid serie type "' + B.type + '"';
          a.isFunction(B.drawBefore) && B.drawBefore(d, b, v, this), 1 != B.polar && 1 != B.spider || -1 == B.type.indexOf("pie") && -1 == B.type.indexOf("donut") && c._renderSpiderAxis(v, q), c._renderAxisBands(v, q, !0), c._renderAxisBands(v, q, !1)
        }
        for (v = 0; v < t.length; v++) {
          var B = t[v];
          if (c._isColumnType(B.type) ? c._renderColumnSeries(v, q) : -1 != B.type.indexOf("pie") || -1 != B.type.indexOf("donut") ? c._renderPieSeries(v, q) : -1 != B.type.indexOf("line") || -1 != B.type.indexOf("area") ? c._renderLineSeries(v, q) : -1 != B.type.indexOf("scatter") || -1 != B.type.indexOf("bubble") ? c._renderScatterSeries(v, q) : -1 == B.type.indexOf("candlestick") && -1 == B.type.indexOf("ohlc") || c._renderCandleStickSeries(v, q, -1 != B.type.indexOf("ohlc")), B.annotations) {
            if (!this._moduleAnnotations) throw "Please include 'jqxchart.annotations.js'";
            for (var W = 0; W < B.annotations.length; W++) c._renderAnnotation(v, B.annotations[W], q)
          }
          a.isFunction(B.draw) && c.draw(d, b, v, this)
        }
        if (d.endGroup(), 0 == c.enabled) {
        ...
        a.isFunction(c.draw) && c.draw(d, b), d.endGroup(), c._startAnimation("series"), c._credits && c._credits();
        for (var Y = !1, v = 0; v < c.seriesGroups.length && !Y; v++) {
          var w = c._getXAxis(v);
          w && w.rangeSelector && (Y = !0)
        }
        if (Y) {
          if (!this._moduleRangeSelector) throw "Please include 'jqxchart.rangeselector.js'";
          var Z = [];
          for (this._isSelectorRefresh || (c.removeHandler(a(document), c._getEvent("mousemove"), c._onSliderMouseMove), c.removeHandler(a(document), c._getEvent("mousedown"), c._onSliderMouseDown), c.removeHandler(a(document), c._getEvent("mouseup"), c._onSliderMouseUp)), c._isSelectorRefresh || (c._rangeSelectorInstances = {}), v = 0; v < c.seriesGroups.length; v++) {
            var $ = this._getXAxis(v); - 1 == Z.indexOf($) && this._renderXAxisRangeSelector(v, N[v]) && Z.push($)
          }
        }
      }
    },
    ...
    _isPieOnlySeries: function() {
      ...
      for (var b = 0; b < a.length; b++)
        if ("pie" != a[b].type && "donut" != a[b].type) return !1;
      return !0
    },
    _renderChartLegend: function(b, c, d, e) {
      ...
      h.width >= 6 && (h.x += 3, h.width -= 6), h.height >= 6 && (h.y += 3, h.height -= 6);
      for (var i = {
          width: h.width,
          height: 0
        }, j = 0, k = 0, l = 20, m = 0, n = 0, o = 0; o < b.length; o++) {
        var p = b[o].css;
        p || (p = f.toThemeProperty("jqx-chart-legend-text", null)), l = 20;
        var q = b[o].text,
          r = g.measureText(q, 0, {
            class: p
          });
        r.height > l && (l = r.height), r.width > n && (n = r.width), e ? (0 != o && (k += l), k > h.height && (k = 0, j += n + 20 + 10, n = r.width, i.width = j + n)) : (0 != j && (j += 10), j + 20 + r.width > h.width && r.width < h.width && (j = 0, k += l, l = 20, m = h.width, i.height = k + l));
        var s = !1;
        if (r.width > h.width) {
          s = !0;
          ...
          for (var B = 0, C = 0; C < w.length; C++) {
            ...
            r.width = Math.max(r.width, A.width), B += r.height
          }
          r.height = B
        }
        var E = j + r.width < h.width && k + r.height < c.height;
        if (f.legendLayout) var E = h.x + j + r.width < f._rect.x + f._rect.width && h.y + k + r.height < f._rect.y + f._rect.height;
        if (!d && E) {
          ...
          if (s) {
            for (var u = q, t = h.width, v = u.split(/\s+/), N = 0, w = [], x = "", y = 0; y < v.length; y++) {
              ...
              A.width > t && z.length > 0 && x.length > 0 ? (w.push({
                text: x,
                dy: N
              }), N += A.height, x = v[y]) : x = z, y + 1 == v.length && w.push({
                text: x,
                dy: N
              })
            }
          ...
          f.renderer.endGroup(), f._setLegendToggleHandler(G, F, H, L)
        }
        e || (j += r.width + 20, m < j && (m = j))
      }
      if (d) return i.height = a.jqx._ptrnd(k + l + 5), i.width = a.jqx._ptrnd(m), i
    },
    isSerieVisible: function(a, b, c) {
      return this._isSerieVisible(a, b, c)
    },
    _isSerieVisible: function(b, c, d) {
      for (; this._itemsToggleState.length < b + 1;) this._itemsToggleState.push([]);
      for (var e = this._itemsToggleState[b]; e.length < c + 1;) e.push(!!isNaN(d) || []);
      var f = e[c];
      if (isNaN(d)) return f;
      for (a.isArray(f) || (e[c] = f = []); f.length < d + 1;) f.push(!0);
      return f[d]
    },
    ...
    _toggleSerie: function(b, c, d, e) {
      ...
      if (this._raiseEvent("toggle", {
          ...
          serie: h,
          elementIndex: d
        }), isNaN(d)) this._itemsToggleState[b][c] = f;
      else {
        var i = this._itemsToggleState[b][c];
        for (a.isArray(i) || (i = []); i.length < d;) i.push(!0);
        i[d] = f
      }
      this._isToggleRefresh = !0, this.update(), this._isToggleRefresh = !1
    },
    ...
    _setLegendToggleHandler: function(a, b, c, d) {
      ...
      if (void 0 == g && (g = 0 != e.enableSeriesToggle), g) {
        var h = this;
            ...
            if (0 != h.showLegend) {
              ...
              if ("pie" != f.type && "donut" != f.type) {
                ...
                for (var p = c._getXAxis(e), k = h.legendFormatSettings || f.legendFormatSettings || p.formatSettings || h.formatSettings || f.formatSettings, l = h.legendFormatFunction || f.legendFormatFunction || p.formatFunction || h.formatFunction || f.formatFunction, q = c._getDataLen(e), r = 0; r < q; r++) {
                  i = c._getDataValue(r, h.displayText, e), i = c._formatValue(i, k, l, e, g, r);
    ...
    _getInterval: function(a, b) {
      ...
      return isNaN(a.step) || (c = a.step * b), c
    },
    _getOffsets: function(a, b, c, d, e, f, g, h, i) {
      ...
      if ("labels" != a) {
        var m = g ? f.left : 0;
        if (!g && h > 1 && (m = f.left * (h + 1)), 1 == k.length && (m *= 2), l = this._valuesToOffsets(k, b, d, c, f, !1, m), !g) {
          var n = (f.left + f.right) * j / h;
          b.flip ? l.unshift(l[0] + n) : l.push(l[l.length - 1] + n)
        }
      } else {
        var m = f.left;
        1 == k.length && (m *= 2), l = this._valuesToOffsets(k, b, d, c, f, g, m)
      }
      var o = this._arraysToObjectsArray([k, l], ["value", "offset"]);
      if (b[a] && b[a].custom)
        for (var p = this._objectsArraysToArray(b[a].custom, "value"), q = this._objectsArraysToArray(b[a].custom, "offset"), r = this._valuesToOffsets(p, b, d, c, f, g, f.left), s = 0; s < b[a].custom.length; s++) o.push({
          value: p[s],
    ...
    _renderXAxis: function(b, c, d, e) {
      ...
      if (!g || !k.visible || "spider" == h.type) return j;
      if (!f._isGroupVisible(b) || this._isPieGroup(b)) return j;
      for (var l = f._alignValuesWithTicks(b); f._renderData.length < b + 1;) f._renderData.push({});
      f.rtl && (g.flip = !0);
      ...
      !d && q && (i ? (c.width -= r, "right" != g.position && (c.x += r)) : (c.height -= r, "top" == g.position && (c.y += r)));
      var t = {
      ...
      var u = p.interval;
      if (isNaN(u)) return j;
      i && (k.title.angle -= 90, k.labels.angle -= 90);
      var v, w = this._getInterval(k.gridLines, u),
        x = this._getInterval(k.tickMarks, u),
        y = this._getInterval(k.labels, u),
        z = p.min,
        A = p.max,
        B = o.padding,
        C = 1 == g.flip || f.rtl,
      ...
      var I;
      k.labels.formatSettings && (I = a.extend({}, k.labels.formatSettings)), "date" == g.type && (g.dateFormat && !G ? I ? I.dateFormat = I.dateFormat || g.dateFormat : I = {
      ...
      for (var J = 0; J < v.length; J++) {
        ...
        if (!isNaN(L)) {
          var M = void 0;
          "date" != g.type && p.useIndeces && g.dataField && (M = Math.round(K), void 0 == (K = f._getDataValue(M, g.dataField)) && (K = ""));
          var n = f._formatValue(K, I, G, b, void 0, M);
          void 0 != n && "" != n.toString() || (isNaN(M) && (M = J), M >= p.filterRange.min && M <= p.filterRange.max && (n = p.useIndeces ? (p.min + M).toString() : void 0 == K ? "" : K.toString()));
          var N = {
            key: K,
            text: n,
            targetX: L,
          ...
          E && E.itemOffsets[K] && (N.x = E.itemOffsets[K].x, N.y = E.itemOffsets[K].y), H.push(N)
        }
      }
      ...
      return i ? R.width += r : R.height += r, R
    },
    _animateAxisText: function(a, b) {
      for (var c = a.items, d = a.textSettings, e = 0; e < c.length; e++) {
        ...
        if (f && f.visible) {
          var g = f.targetX,
            h = f.targetY;
          isNaN(f.x) || isNaN(f.y) || (g = f.x + (g - f.x) * b, h = f.y + (h - f.y) * b), f.element && (this.renderer.removeElement(f.element), f.element = void 0), f.element = this.renderer.text(f.text, g, h, f.width, f.height, d.angle, {
            class: d.style
    ...
    _getPolarAxisCoords: function(b, c) {
      var d = this.seriesGroups[b],
        ...
        h = d.radius;
      this._isPercent(h) && (h = parseFloat(h) / 100 * g / 2), isNaN(h) && (h = g / 2 * .6);
      ...
      if (k = isNaN(k) ? 2 * Math.PI : 2 * Math.PI * k / 360, j > k) {
        var l = j;
        j = k, k = l
      }
        ...
        if (h) {
          ...
          if (!(k < 1)) {
            ...
            if (q.rangeLength) {
              ...
              for (s && "right" == e.position || !s && e.position; d._renderData.length < b + 1;) d._renderData.push({});
              var t = {
              ...
              d._renderData[b].xAxis = t, d._renderData[b].polarCoords = h;
              for (var u = !0, v = 0; v < b; v++) {
                var w = (d._renderData[v].xAxis, d._renderData[v].polarCoords),
                  x = d._getXAxis(v),
                  y = !1;
                for (var z in h)
                  if (h[z] != w[z]) {
              ...
              var A, B = f.gridLines,
                C = f.tickMarks,
                D = f.labels,
                E = this._getInterval(B, r),
                F = this._getInterval(C, r),
                G = this._getInterval(D, r),
                H = d._alignValuesWithTicks(b),
                I = d.renderer,
                J = q.axisStats,
                K = J.min,
                L = J.max,
                M = this._getPaddingSize(q.axisStats, e, H, o, !0, p, !1),
                N = 1 == e.flip || d.rtl;
              "date" == e.type ? (B.offsets = this._generateDTOffsets(K, L, o, M, E, r, e.baseUnit, !0, 0, !1, N), C.offsets = this._generateDTOffsets(K, L, o, M, F, r, e.baseUnit, !0, 0, !1, N), A = this._generateDTOffsets(K, L, o, M, G, r, e.baseUnit, !0, 0, !0, N)) : (f.gridLines.offsets = this._getOffsets("gridLines", e, o, J, f, M, !0, r), f.tickMarks.offsets = this._getOffsets("tickMarks", e, o, J, f, M, !0, r), A = this._getOffsets("labels", e, o, J, f, M, !0, r));
              var O, P = d.renderer.getRect();
              P.width, c.x, c.width, d._getDataLen(b);
              ...
              for (var Q = [], R = this._getDataLen(b), v = 0; v < A.length; v++) {
                ...
                if ("date" != e.type && J.useIndeces && e.dataField) {
                  var U = Math.round(T);
                  if (U >= R) continue;
                  T = d._getDataValue(U, e.dataField), void 0 == T && (T = "")
                }
                ...
                O && O.itemOffsets[T] && (W.x = O.itemOffsets[T].x, W.y = O.itemOffsets[T].y), Q.push(W)
              }
              var X = {
                stroke: B.color,
                fill: "none",
              ...
              if (g.spider) {
                var ia = [];
                ia = "date" == e.type ? this._generateDTOffsets(K, L, o, M, r, r, e.baseUnit, !0, 0, !1, N) : this._getOffsets("", e, o, J, f, M, !0, r), H || p || ia.unshift({
                  offset: -M.right
                });
              ...
              if (ja || (ja = []), g.spider) {
                if (!H)
                  for (var v = 0; v < ja.length; v++) ja[v] = ja[v] * h.adjR / h.r;
                ja.push(k), this._renderSpiderLines(i, j, ja, h, ha, X)
              }
              if (u && D.visible) {
                t.polarLabels = [];
                for (var v = 0; v < Q.length; v++) {
                  ...
                  ba = (360 - ba / (2 * Math.PI) * 360) % 360, ba < 0 && (ba = 360 + ba);
                  var ka, la = I.measureText(Q[v].text, 0, {
                      class: f.labels.style
                    }),
                    ma = (H ? h.adjR : h.r) + (C.visible ? 7 : 2),
                    na = f.labels;
                  if (na.autoRotate) {
                    ...
                    la.width = Math.abs(oa.x - pa.x), la.height = Math.abs(oa.y - pa.y), ka = {
                      x: Math.min(oa.x, pa.x),
                      y: Math.min(oa.y, pa.y)
                    }
                  } else ka = this._adjustTextBoxPosition(i, j, la, ma, ba, !1, !1, !1);
                  t.polarLabels.push({
                    x: ka.x,
                    y: ka.y,
                    value: Q[v].text
    ...
    _renderSpiderLines: function(b, c, d, e, f, g) {
      for (var h = this.renderer, i = (e.startAngle, e.endAngle, e.isClosedCircle), j = 0; j < d.length; j++) {
        for (var k = d[j], l = void 0, m = void 0, n = 0; n < f.length; n++) {
          var o = f[n],
            p = a.jqx._ptrnd(b + k * Math.cos(o)),
            q = a.jqx._ptrnd(c + k * Math.sin(o));
          l && h.line(l.x, l.y, p, q, g), l = {
            x: p,
            y: q
          }, m || (m = {
            x: p,
    ...
    _renderSpiderValueAxis: function(b, c, d, e) {
      ...
      if (g) {
        ...
        if (!(d < 1)) {
          ...
          if (settings = this._getAxisSettings(m), m && 0 != settings.visible) {
            var n = this._stats.seriesGroups[b].mu,
              o = settings.labels,
              p = o.formatSettings; - 1 != f.type.indexOf("stacked") && -1 != f.type.indexOf("100") && !p && (p = {
              sufix: "%"
            });
            var q = this._get([o.step, o.unitInterval / n]);
            isNaN(q) && (q = 1), q = Math.max(1, Math.round(q)), this._calcValueAxisItems(b, d, q);
            var r = settings.gridLines,
              s = settings.tickMarks,
              t = (this._getInterval(r, n), this._getInterval(s, n), settings.labels),
              u = {
                stroke: r.color,
                fill: "none",
                "stroke-width": 1,
            ...
            if (w.length && settings.line.visible) {
              ...
              if (-1 == e.indexOf(x)) {
                var A = a.extend({}, u);
                A["stroke-width"] = settings.line.lineWidth, A.stroke = settings.line.color, A["stroke-dasharray"] = settings.line.dashStyle, this.renderer.line(h, i, y, z, A)
              }
            }
            w = w.reverse();
            var B = this.renderer;
            ...
            for (var C = 0; C < w.length - 1; C++) {
              ...
              if (!isNaN(D)) {
                ...
                G = Math.min(I.x, J.x), H = Math.min(I.y, J.y), F.width = Math.abs(I.x - J.x), F.height = Math.abs(I.y - J.y), G += settings.labels.textOffset.x, H += settings.labels.textOffset.y, v.polarLabels.push({
                  x: G,
                  y: H,
                  value: E
            ...
            if (r.visible || f.spider)
              for (var u = {
                ...
                if (H != d)
                  if (f.spider) R.push(H);
                  else if (1 != l) {
                  var S = -j / Math.PI * 180,
                    T = -k / Math.PI * 180;
                  this.renderer.pieslice(h, i, 0, H, Math.min(S, T), Math.max(S, T), void 0, u)
                } else B.circle(h, i, H, u)
              }
            if (m.tickMarks && (m.tickMarks.visible || m.showTickMarks) || (s.visible = !1), s.visible) {
              s.offsets = this._getOffsets("tickMarks", m, d, Q, settings, {
                left: 0,
                right: 0
              }, M, O), tickMarkSize = 2 * s.size;
              for (var u = {
                  stroke: s.color,
                  fill: "none",
                  "stroke-width": 1,
    ...
    _renderAxis: function(b, c, d, e, f, g, h, i, j, k, l) {
      if (d.customDraw && !k) return {
        width: NaN,
        height: NaN
      };
      var m = d.title,
        n = d.labels,
        o = (d.gridLines, d.tickMarks),
        p = d.padding,
      ...
      b ? r.height = s.height = e.height : r.width = s.width = e.width, !k && c && b && (e.x -= e.width);
      var t = j.renderData,
        u = t.itemWidth;
      if (m.visible && void 0 != m.text && "" != m) {
        ...
        s.width = w.width, s.height = w.height, k || this.renderer.text(m.text, e.x + m.offset.x + (b ? c ? -p.right - 2 + 2 * e.width - s.width : 2 + p.left : 0), e.y + m.offset.y + (b ? 0 : c ? p.top + 2 : e.height - 2 - s.height - p.bottom), b ? s.width : e.width, b ? e.height : s.height, v, {
          class: m.style
      ...
      var z = e.x,
        A = e.y,
        B = n.textOffset;
      B && (isNaN(B.x) || (z += B.x), isNaN(B.y) || (A += B.y)), b ? (z += p.left + 2 + (s.width > 0 ? s.width + 2 : 0) + (c ? e.width - s.width : 0), A += y) : (z += y, c ? (A += s.height > 0 ? s.height + 6 : 4, A += q - (i ? q : q / 4)) : A += i ? q : q / 4, A += p.top);
      var C = 0,
        D = 0,
        E = j.items;
      t.itemOffsets = {}, !this._isToggleRefresh && this._isUpdate || (l = 0);
      for (var F = !1, G = 0, H = 0; H < E.length && n.visible; H++, x += u)
        if (E[H] && !isNaN(u)) {
          var I = E[H].text;
          ...
          if (w.width > D && (D = w.width), w.height > C && (C = w.height), G += b ? C : D, !k) {
            if (b && x > e.height + 2 || !b && x > e.width + 2) continue;
            var J = b ? z + (c ? 0 == s.width ? q : q - 2 : 0) : z + x,
              K = b ? A + x : A;
            t.itemOffsets[E[H].key] = {
              x: J,
              y: K
            }, F || (!isNaN(E[H].x) || !isNaN(E[H].y) && l) && (F = !0), E[H].targetX = J, E[H].targetY = K, E[H].width = b ? e.width - p.left - p.right - 4 - q - (s.width > 0 ? s.width + 2 : 0) : u, E[H].height = b ? u : e.height - p.top - p.bottom - 4 - q - (s.height > 0 ? s.height + 2 : 0), E[H].visible = !0
          }
        }
      if (t.avgWidth = 0 == E.length ? 0 : G / E.length, !k) {
        var L = {
          items: E,
          textSettings: n
        };
        if (!isNaN(l) && F || (l = 0), this._animateAxisText(L, 0 == l ? 1 : 0), 0 != l) {
          var M = this;
      ...
      r.width += 4 + q + s.width + D + (b && s.width > 0 ? 2 : 0), r.height += 4 + q + s.height + C + (!b && s.height > 0 ? 2 : 0), b ? r.width += p.left + p.right : r.height += p.top + p.bottom;
      if (!k && d.line.visible) {
        var N = {
          stroke: d.line.color,
        ...
        if (b) {
          ...
          J = a.jqx._ptrnd(J), this.renderer.line(J, e.y, J, e.y + e.height, N)
        } else {
          var K = a.jqx._ptrnd(e.y + (c ? e.height - p.bottom : p.top));
          this.renderer.line(a.jqx._ptrnd(e.x), K, a.jqx._ptrnd(e.x + e.width + 1), K, N)
        }
      }
      return r.width = a.jqx._rup(r.width), r.height = a.jqx._rup(r.height), r
    },
    _drawPlotAreaLines: function(b, c, d) {
      ...
      if (this._renderData && !(this._renderData.length <= b)) {
        ...
        if (h) {
          ...
          var j, k = "";
          c ? (k = "valueAxis_" + (e.valueAxis ? b : "") + (f ? "swap" : ""), j = this._getValueAxis(b)) : (k = "xAxis_" + (e.xAxis || e.categoryAxis ? b : "") + (f ? "swap" : ""), j = this._getXAxis(b)), i = i[k] ? i[k] : i[k] = {}, c || (f = !f);
          var l = h.settings;
          if (l && !l.customDraw) {
            var m = l.gridLines,
              n = l.tickMarks,
            ...
            if (m && n) {
              var r = {},
                ...
                u = m.offsets;
              if (c && !j.flip && (u = a.extend([], u), u = u.reverse()), u && u.length > 0)
                for (var v = NaN, w = (u.length, 0); w < u.length; w++)
                  if (f ? (lineOffset = a.jqx._ptrnd(p.y + u[w].offset), lineOffset < p.y - .5 && (lineOffset = a.jqx._ptrnd(p.y)), lineOffset > p.y + p.height && (lineOffset = p.y + p.height)) : (lineOffset = a.jqx._ptrnd(p.x + u[w].offset), lineOffset > p.x + p.width + .5 && (lineOffset = a.jqx._ptrnd(p.x + p.width))), !isNaN(lineOffset) && (isNaN(v) || !(Math.abs(lineOffset - v) < 2))) {
                    if (v = lineOffset, d.gridLines && 0 != m.visible && 1 != i.gridLines && (f ? this.renderer.line(a.jqx._ptrnd(q.x), lineOffset, a.jqx._ptrnd(q.x + q.width), lineOffset, s) : this.renderer.line(lineOffset, a.jqx._ptrnd(q.y), lineOffset, a.jqx._ptrnd(q.y + q.height), s)), r[lineOffset] = !0, d.alternatingBackground && (m.alternatingBackgroundColor || m.alternatingBackgroundColor2) && 1 != i.alternatingBackground) {
                      var x = w % 2 == 0 ? m.alternatingBackgroundColor2 : m.alternatingBackgroundColor;
                      if (w > 0 && x) {
                        var y;
                        y = f ? this.renderer.rect(a.jqx._ptrnd(q.x), t, a.jqx._ptrnd(q.width - 1), lineOffset - t, s) : this.renderer.rect(t, a.jqx._ptrnd(q.y), lineOffset - t, a.jqx._ptrnd(q.height), s), this.renderer.attr(y, {
                          "stroke-width": 0,
                          fill: x,
              ...
              if (d.tickMarks && n.visible && 1 != i.tickMarks)
                for (var z = n.size, u = n.offsets, v = NaN, w = 0; w < u.length; w++)
                  if (f ? (lineOffset = a.jqx._ptrnd(p.y + u[w].offset), lineOffset < p.y - .5 && (lineOffset = a.jqx._ptrnd(p.y)), lineOffset > p.y + p.height && (lineOffset = p.y + p.height)) : (lineOffset = a.jqx._ptrnd(p.x + u[w].offset), lineOffset > p.x + p.width + .5 && (lineOffset = a.jqx._ptrnd(p.x + p.width))), !isNaN(lineOffset) && (isNaN(v) || !(Math.abs(lineOffset - v) < 2))) {
                    if (r[lineOffset - 1] ? lineOffset-- : r[lineOffset + 1] && lineOffset++, f) {
                      if (lineOffset > p.y + p.height + .5) break
                    } else if (lineOffset > p.x + p.width + .5) break;
                    v = lineOffset;
                    var A = h.isMirror ? z : -z;
                    if (f) {
                      var B = p.x + p.width + ("right" == j.position ? o.left : -o.right);
                      c || (B = p.x + (h.isMirror ? o.left : -o.right + p.width)), this.renderer.line(B, lineOffset, B + A, lineOffset, s)
                    } else {
                      var C = p.y + (h.isMirror ? p.height : 0);
                      C += h.isMirror ? -o.bottom : o.top, C = a.jqx._ptrnd(C), this.renderer.line(lineOffset, C, lineOffset, C - A, s)
                    }
                  }
              i.tickMarks = i.tickMarks || d.tickMarks, i.gridLines = i.gridLines || d.gridLines, i.alternatingBackground = i.alternatingBackground || d.alternatingBackground
            }
          }
        }
      }
    ...
    _calcValueAxisItems: function(a, b, c) {
      ...
      if (!d || !d.isValid) return !1;
      var e = this.seriesGroups[a],
        f = (e.orientation, this._getValueAxis(a)),
        g = 0 != f.valuesOnTicks,
        h = (f.dataField, d.intervals),
        i = b / h,
        j = d.min,
        k = d.mu,
      ...
      for (l && (k = isNaN(f.unitInterval) ? 1 : f.unitInterval), g || (h = Math.max(h - 1, 1)); this._renderData.length < a + 1;) this._renderData.push({});
      this._renderData[a].valueAxis = {};
      var o = this._renderData[a].valueAxis;
      o.itemWidth = o.intervalWidth = i, o.items = [];
      for (var p = o.items, q = 0; q <= h; q++) {
        var r = 0;
        r = l ? n ? d.max / Math.pow(m, h - q) : j * Math.pow(m, q) : g ? j + q * k : j + (q + .5) * k, q % c == 0 ? p.push(r) : p.push(NaN)
      }
      return o.rangeLength = l && !n ? d.intervals : d.intervals * k, 1 != f.flip && (p = p.reverse()), !0
    },
      ...
      for (var e = 0; e < a.length; e++) {
        ...
        if (!isNaN(f)) {
          for (var g = f.toString(), h = 0; h < g.length; h++)
            if ((g[h] < "0" || g[h] > "9") && (d = g.length - (h + 1)) >= 0) return Math.min(d, c);
          for (d > 0 && (f *= Math.pow(10, d)); Math.round(f) != f && d < c;) d++, f *= 10
        }
      }
      return d
    },
    _renderValueAxis: function(a, b, c, d) {
      ...
      if (!g) throw "SeriesGroup " + a + " is missing valueAxis definition";
      var h = {
        width: 0,
        height: 0
      };
      if (!this._isGroupVisible(a) || this._isPieOnlySeries() || "spider" == e.type) return h;
      var i = 0 != g.valuesOnTicks,
        j = this._stats.seriesGroups[a],
        k = j.mu,
        l = 1 == g.logarithmicScale;
      g.logarithmicScaleBase;
      if (l && (k = isNaN(g.unitInterval) ? 1 : g.unitInterval), 0 == k && (k = 1), isNaN(k)) return h;
      ...
      if (isNaN(q) && (q = 1), q = Math.max(1, Math.round(q)), !this._calcValueAxisItems(a, f ? b.width : b.height, q) || !m.visible) return h;
      f || (n.angle = this.rtl ? 90 : -90, "centercenter" == n.rotationPoint && ("top" == n.valign ? n.rotationPoint = "rightcenter" : "bottom" == n.valign && (n.rotationPoint = "leftcenter")));
      var r = this._renderData[a].valueAxis,
        s = o.formatSettings; - 1 != e.type.indexOf("stacked") && -1 != e.type.indexOf("100") && !s && (s = {
        sufix: "%"
      }), o.formatFunction || s && s.decimalPlaces || (s = s || {}, s.decimalPlaces = this._getDecimalPlaces([j.min, j.max, k], void 0, 3));
      var t = m.gridLines,
        u = (l || this._getInterval(t, k), f ? b.width : b.height),
        v = 1 == g.flip;
      g.flip = !v;
      var w = {
        min: j.min,
      ...
      x.visible && (x.offsets = this._getOffsets("tickMarks", g, u, w, m, {
        left: 0,
        right: 0
      }, i, k)), labelOffsets = this._getOffsets("labels", g, u, w, m, {
        left: 0,
        right: 0
      }, i, k, !i), g.flip = v;
      var y, z = [];
      ...
      for (var A = 0; A < labelOffsets.length; A++) {
        ...
        if (isNaN(labelOffsets[A].offset)) z.push(void 0);
        else {
          ...
          y && y.itemOffsets[B] && (D.x = y.itemOffsets[B].x, D.y = y.itemOffsets[B].y), D.targetX = labelOffsets[A].offset, isNaN(D.targetX) || z.push(D)
        }
      }
      ...
      return 0 == this.enableAxisTextAnimation && (H = 0), r.settings = m, r.isMirror = E, r.rect = b, this._renderAxis(!f, E, m, b, d, k, l, !0, F, c, H)
    },
    _objectsArraysToArray: function(b, c) {
      var d = [];
      if (!a.isArray(b)) return d;
      for (var e = 0; e < b.length; e++) d.push(b[e][c]);
      return d
    },
    _arraysToObjectsArray: function(a, b) {
      ...
      for (var d = 0; d < a.length; d++)
        for (var e = 0; e < a[d].length; e++) c.length <= e && c.push({}), c[e][b[d]] = a[d][e];
      return c
    },
    _valuesToOffsets: function(b, c, d, e, f, g, h) {
      var i = [];
      if (!c || !a.isArray(b)) return i;
      var j = d.logAxis.base,
        ...
        n = 0,
        o = 0;
      f && !isNaN(f.left) && (n = f.left), f && !isNaN(f.right) && (o = f.right), m = e - n - o, e = m;
      for (var p = 0; p < b.length; p++) x = this._jqxPlot.scale(b[p], {
        min: d.min.valueOf(),
        max: d.max.valueOf(),
        type: k,
        base: j
        ...
        max: g ? e : m,
        flip: l
      }, {}), isNaN(x) ? i.push(NaN) : (isNaN(h) || (x += h), x <= e + n + o + 1 ? i.push(a.jqx._ptrnd(x)) : i.push(NaN));
      return i
    },
    _generateIntervalValues: function(a, b, c, d, e) {
      var f = [],
        g = a.min,
        h = a.max;
      if (a.logAxis && a.logAxis.enabled && (g = a.logAxis.minPow, h = a.logAxis.maxPow), void 0 == g || void 0 == h) return f;
      if (g == h) return a.logAxis && a.logAxis.enabled ? [Math.pow(a.logAxis.base, g)] : [g];
      var i = 1;
      c < 1 && (i = 1e6, g *= i, h *= i, c *= i);
      for (var j = g; j <= h; j += c) f.push(j / i + (e ? c / 2 : 0));
      if (b > c) {
        for (var k = [], l = Math.round(b / c), j = 0; j < f.length; j++) j % l == 0 && k.push(f[j]);
        f = k
      }
      if (a.logAxis && a.logAxis.enabled)
        for (var j = 0; j < f.length; j++) f[j] = Math.pow(a.logAxis.base, f[j]);
      return f
    },
    _generateDTOffsets: function(b, c, d, e, f, g, h, i, j, k, l) {
      ...
      for (g > 1 && "millisecond" != h && (g = 1); a.jqx._ptrnd(q) <= a.jqx._ptrnd(e.left + n + (i ? 0 : e.right));) {
        ...
        if ("millisecond" == h) t.setMilliseconds(o.getMilliseconds() + g);
        else if ("second" == h) t.setSeconds(o.getSeconds() + g);
        else if ("minute" == h) t.setMinutes(o.getMinutes() + g);
        else if ("hour" == h) {
          var u = t.valueOf();
          t.setHours(o.getHours() + g), u == t.valueOf() && t.setHours(o.getHours() + g + 1)
        } else "day" == h ? t.setDate(o.getDate() + g) : "month" == h ? t.setMonth(o.getMonth() + g) : "year" == h && t.setFullYear(o.getFullYear() + g);
        o = t, q = p + (o.valueOf() - b.valueOf()) * s / (c.valueOf() - b.valueOf()) * n
      }
      if (l)
        for (var v = 0; v < m.length; v++) m[v].offset = d - m[v].offset;
      if (r > 1 && "millisecond" != h) {
        for (var w = [], v = 0; v < m.length; v += r) w.push({
          offset: m[v].offset,
          value: m[v].value
        });
        m = w
      ...
      if (!i && !k && m.length > 1) {
        ...
        for (var v = 1; v < m.length; v++) w.push({
      ...
      if (f > g) {
        for (var w = [], y = Math.round(f / r), v = 0; v < m.length; v++) v % y == 0 && w.push({
          offset: m[v].offset,
          value: m[v].value
        });
        m = w
    ...
    _hasStackValueReversal: function(a, b) {
      ...
      if (-1 == c.type.indexOf("stacked")) return !1;
      for (var d = -1 != c.type.indexOf("waterfall"), e = this._getDataLen(a), f = 0, g = !1, h = [], i = 0; i < c.series.length; i++) h[i] = this._isSerieVisible(a, i);
      for (var j = 0; j < e; j++) {
        var k = void 0;
        d || (g = !1);
        for (var l = 0; l < c.series.length; l++)
          if (h[l] && (val = this._getDataValueAsNumber(j, c.series[l].dataField, a), !isNaN(val))) {
            if (c.series[l].summary) {
              var m = this._getDataValue(j, c.series[l].summary, a);
              if (void 0 !== m) continue
            }
            var n = g ? val < 0 : val < b;
            if (g = !0, void 0 == k && (k = n), n != k) return !0;
            k = n, f += val
          }
      }
      return !1
    ...
    _buildStats: function(a) {
      ...
      for (var c = 0; c < this.seriesGroups.length; c++) {
        ...
        if (o && !this._moduleWaterfall) throw "Please include 'jqxchart.waterfall.js'";
        m && (h.psums = [], h.nsums = []);
        var p = NaN,
          q = NaN,
          r = NaN,
        ...
        isNaN(t) && (t = j && !m ? 1 : 0);
        var u = !1;
        0 != t && l && (u = this._hasStackValueReversal(c, t)) && (t = 0), l && o && (u = this._hasStackValueReversal(c, t));
        var v = this._getDataLen(c),
          w = 0,
          x = NaN,
          y = [];
        if (o)
          for (var z = 0; z < d.series.length; z++) y.push(NaN);
        for (var A = NaN, B = 0; B < v && h.isValid; B++) {
          if (e.rangeSelector) {
            var C = e.dataField ? this._getDataValue(B, e.dataField, c) : B;
            if (C && g.isDateTime && (C = this._castAsDate(C, e.dateFormat)), g.useIndeces && (C = B), C && (C.valueOf() < g.min.valueOf() || C.valueOf() > g.max.valueOf())) continue
          }
          var D = f.minValue,
            E = f.maxValue;
          f.baselineValue && (D = isNaN(D) ? t : Math.min(t, D), E = isNaN(E) ? t : Math.max(t, E));
            ...
            if (this._isSerieVisible(c, z)) {
              ...
              if (-1 != d.type.indexOf("candle") || -1 != d.type.indexOf("ohlc")) {
                ...
                for (var L in K) {
                  ...
                  isNaN(M) || (J = isNaN(I) ? M : Math.min(J, M), I = isNaN(I) ? M : Math.max(I, M))
                }
              } else if (n) {
                var N = this._getDataValueAsNumber(B, d.series[z].dataFieldFrom, c),
                  O = this._getDataValueAsNumber(B, d.series[z].dataFieldTo, c);
                I = Math.max(N, O), J = Math.min(N, O)
              } else {
                if (H = this._getDataValueAsNumber(B, d.series[z].dataField, c), o) {
                  if (this._isSummary(c, B)) {
                    var P = this._getDataValue(B, d.series[z].summary, c);
                    if (void 0 !== P) continue
                  }
                  l ? (isNaN(A) || (H += A), A = H) : (isNaN(y[z]) ? y[z] = H : H += y[z], y[z] = H)
                }
                if (isNaN(H) || j && H <= 0) continue;
                J = I = H
              }(isNaN(E) || I > E) && (isNaN(f.maxValue) || I <= f.maxValue) && (E = I), (isNaN(D) || J < D) && (isNaN(f.minValue) || J >= f.minValue) && (D = J), isNaN(H) || !l || o || (H > t ? F += H : H < t && (G += H))
            }
          if (m || (isNaN(f.maxValue) || (F = Math.min(f.maxValue, F)), isNaN(f.minValue) || (G = Math.max(f.minValue, G))), j && m)
          ...
          var R = F - G;
          w < R && (w = R), m && (h.psums[B] = F, h.nsums[B] = G), (E > q || isNaN(q)) && (q = E), (D < p || isNaN(p)) && (p = D), (F > r || isNaN(r)) && (r = F), (G < s || isNaN(s)) && (s = G)
        }
        m && (r = 0 == r ? 0 : Math.max(r, -s), s = 0 == s ? 0 : Math.min(s, -r)), p == q && (!isNaN(f.minValue) && isNaN(f.maxValue) ? (p = f.minValue, q = j ? p * k : p + 1) : isNaN(f.minValue) && !isNaN(f.maxValue) && (q = f.maxValue, p = j ? q / k : q - 1)), p == q && (0 == p ? (p = -1, q = 1) : p < 0 ? q = 0 : j ? 1 == p && (p /= k, q *= k) : p = 0);
        var S = {
          gmin: p,
          gmax: q,
          gsumP: r,
        ...
        S.isStacked && (S.gsumN < 0 && (S.gmin = Math.min(S.gmin, S.gbase + S.gsumN)), S.gsumP > 0 && (S.gmax = Math.max(S.gmax, S.gbase + S.gsumP))), h.context = S
      }
    ...
    _mergeCommonValueAxisStats: function() {
      for (var a = {}, b = 0; b < this.seriesGroups.length; b++)
        if (this._isGroupVisible(b) && !this.seriesGroups[b].valueAxis) {
          ...
          a.gbase = c.gbase, (isNaN(a.gmin) || c.gmin < a.gmin) && (a.gmin = c.gmin), (isNaN(a.gmax) || c.gmax > a.gmax) && (a.gmax = c.gmax), (isNaN(a.gsumP) || c.gsumP > a.gsumP) && (a.gsumP = c.gsumP), (isNaN(a.gsumN) || c.gsumN < a.gsumN) && (a.gsumN = c.gsumN), (isNaN(a.logBase) || c.logBase < a.logBase) && (a.logBase = c.logBase), (isNaN(a.minPercent) || c.minPercent < a.minPercent) && (a.minPercent = c.minPercent), a.gsumN > 0 && (a.gmin = Math.min(a.gmin, a.gbase + a.gsumN)), a.gsumP > 0 && (a.gmax = Math.max(a.gmax, a.gbase + a.gsumP))
        }
      for (var b = 0; b < this.seriesGroups.length; b++)
    ...
    _calcOutputGroupStats: function(b) {
      ...
      r || (r = this._calcInterval(c, d, Math.max(q / 80, 2))), c == d && (c = g, d *= 2);
      var s = NaN,
        t = 0,
        u = 0;
      if (h) {
        if (m) {
          s = 0;
          var v = 1;
          for (t = u = a.jqx.log(100, i); v > j;) v /= i, t--, s++;
          c = Math.pow(i, t)
        } else l && !n && (d = Math.max(d, e)), u = a.jqx._rnd(a.jqx.log(d, i), 1, !0), d = Math.pow(i, u), t = a.jqx._rnd(a.jqx.log(c, i), 1, !1), c = Math.pow(i, t);
        r = i
      }
      c < f && (f = c), d > e && (e = d);
      var w = h ? c : a.jqx._rnd(c, r, !1),
        x = h ? d : a.jqx._rnd(d, r, !0);
      if (m && x > 100 && (x = 100), m && !h && (x = x > 0 ? 100 : 0, w = w < 0 ? -100 : 0, r = p.unitInterval, (isNaN(r) || r <= 0 || r >= 100) && (r = 10), 100 % r != 0))
        for (; r >= 1 && 100 % r != 0; r--);
      return isNaN(x) || isNaN(w) || isNaN(r) ? {} : (isNaN(s) && (s = parseInt(((x - w) / (0 == r ? 1 : r)).toFixed())), h && !m && (s = u - t, k = Math.pow(i, s)), s < 1 ? {} : {
        min: w,
        max: x,
        logarithmic: h,
        logBase: i,
    ...
    _getDataLen: function(b) {
      var c = this.source;
      return void 0 != b && -1 != b && this.seriesGroups[b].source && (c = this.seriesGroups[b].source), c instanceof a.jqx.dataAdapter && (c = c.records), c ? c.length : 0
    },
    _getDataValue: function(b, c, d) {
      var e = this.source;
      if (void 0 != d && -1 != d && (e = this.seriesGroups[d].source || e), e instanceof a.jqx.dataAdapter && (e = e.records), !(!e || b < 0 || b > e.length - 1)) return a.isFunction(c) ? c(b, e) : c && "" != c ? e[b][c] : e[b]
    },
    _getDataValueAsNumber: function(a, b, c) {
      var d = this._getDataValue(a, b, c);
      return this._isDate(d) ? d.valueOf() : ("number" != typeof d && (d = parseFloat(d)), "number" != typeof d && (d = void 0), d)
    },
      ...
      for (var d = this._getDataLen(b), e = this.seriesGroups[b], f = this._calcGroupOffsets(b, c).offsets, g = 0; g < e.series.length; g++) {
        ...
        if (!h.customDraw) {
          var i = this._getSerieSettings(b, g),
            j = (h.colorScheme || e.colorScheme || this.colorScheme, this._getAnimProps(b, g)),
    ...
    _animatePieSlices: function(a, b) {
      ...
      for (var n = NaN, h = 0; h < g.length; h++) {
        var i = a.items[g[h].index],
          ...
          j = g[h].from,
          k = g[h].to;
        c && (!isNaN(n) && j > n && (j = n), n = k, h == g.length - 1 && k != g[0].from && (k = a.maxAngle + g[0].from));
        ...
        var q = this._getColors(a.groupIndex, a.serieIndex, i.itemIndex, "radialGradient", i.outerRadius),
          r = a.settings;
        o.colors = q, o.settings = r, this.renderer.attr(o.element, {
          fill: q.fillColor,
          stroke: q.lineColor,
        ...
        f && this._showPieLabel(a.groupIndex, a.serieIndex, i.itemIndex, e), 1 == b && this._installHandlers(o.element, "pieslice", a.groupIndex, a.serieIndex, i.itemIndex)
      }
    },
    _showPieLabel: function(b, c, d, e, f) {
      var g = this._renderData[b].offsets[c][d];
      if (g.elementInfo.labelElement && this.renderer.removeElement(g.elementInfo.labelElement), e || (e = this._getLabelsSettings(b, c, NaN)), e.visible) {
        var h = g.fromAngle,
          i = g.toAngle,
          j = Math.abs(h - i);
        j > 360 && (h = 0, i = 360);
        var k = (Math.PI, Math.PI, j / 2 + h);
        k %= 360;
        ...
        this._isPercent(p) && (p = parseFloat(p) / 100 * Math.min(this._plotRect.width, this._plotRect.height) / 2), p += g.centerOffset, isNaN(f) && (f = 0), p += f;
        ...
        if (g.elementInfo.labelElement = this._showLabel(b, c, d, {
            ...
            width: o.width,
            height: o.height
          }, "left", "top", !1, !1, !1, l, x), p > g.outerRadius + 5 && 0 != n) {
          var y = {
    ...
    _updateLebelArrowPath: function(b, c, d, e, f, g, h, i, j) {
      ...
      for (var p = 0; p < o.length; p++) o[p].x = a.jqx._ptrnd(o[p].x), o[p].y = a.jqx._ptrnd(o[p].y);
      k = o[0].x, l = o[0].y;
      var q = "M " + k + "," + l + " L" + m + "," + n;
      return h && (q = "M " + k + "," + l + " L" + m + "," + l + " L" + m + "," + n), b ? this.renderer.attr(b, {
        d: q
      }) : b = this.renderer.path(q, {}), this.renderer.attr(b, {
        fill: "none",
        stroke: i.lineColor,
    ...
    _adjustTextBoxPosition: function(b, c, d, e, f, g, h, i) {
      ...
      if (i) {
        var m = d.width,
          ...
          p = j % (2 * Math.PI),
          q = 0;
        p <= o ? q = m / 2 * Math.cos(j) : p >= o && p < Math.PI - o ? q = n / 2 * Math.sin(j) : p >= Math.PI - o && p < Math.PI + o ? q = m / 2 * Math.cos(j) : p >= Math.PI + o && p < 2 * Math.PI - o ? q = n / 2 * Math.sin(j) : p >= 2 * Math.PI - o && p < 2 * Math.PI && (q = m / 2 * Math.cos(j)), e += Math.abs(q) + 3;
        var k = a.jqx._ptrnd(b + e * Math.cos(j)),
          l = a.jqx._ptrnd(c - e * Math.sin(j));
        return k -= d.width / 2, l -= d.height / 2, {
          x: k,
          y: l
        }
      }
      return g ? (k -= d.width / 2, l -= d.height / 2) : h ? f >= 90 && f < 270 ? (l -= d.height / 2, k -= d.width) : l -= d.height / 2 : f >= 0 && f < 45 || f >= 315 && f < 360 ? l -= d.height / 2 : f >= 45 && f < 135 ? (l -= d.height, k -= d.width / 2) : f >= 135 && f < 225 ? (l -= d.height / 2, k -= d.width) : f >= 225 && f < 315 && (k -= d.width / 2), {
        x: k,
        y: l
      }
    },
    ...
    _getColumnGroupsCount: function(a) {
      ...
      return this.columnSeriesOverlap && (b = 1), b
    },
    ...
    _renderAxisBands: function(b, c, d) {
      ...
      if (!g) {
        for (var h = 0; h < b; h++) {
          if ((d ? this._getXAxis(h) : this._getValueAxis(h)) == e) return
        }
        g = e.bands
      }
      if (a.isArray(g)) {
        ...
        for (var h = 0; h < g.length; h++) {
          var k, l = g[h],
            m = this._get([l.minValue, l.from]),
            n = this._get([l.maxValue, l.to]),
            o = d ? this.getXAxisDataPointOffset(m, b) : this.getValueAxisDataPointOffset(m, b),
            p = d ? this.getXAxisDataPointOffset(n, b) : this.getValueAxisDataPointOffset(n, b),
            q = Math.abs(o - p);
          if (f.polar || f.spider) {
            ...
            if (d)
              if (f.spider) {
                p1 = this.getPolarDataPointOffset(m, this._stats.seriesGroups[b].max, b), p2 = this.getPolarDataPointOffset(n, this._stats.seriesGroups[b].max, b);
                var t = "M " + s.x + "," + s.y;
                t += " L " + p1.x + "," + p1.y, t += " L " + p2.x + "," + p2.y, k = this.renderer.path(t)
              } else {
                var u = {},
                  v = {
                    x: Math.min(o, p),
                ...
                this._columnAsPieSlice(u, c, s, v), k = u.element
              }
            else {
              ...
              if (f.spider) {
                var E = r.xAxis.offsetAngles,
                  ...
                  F = [A, z],
                  G = E;
                s.isClosedCircle && (G = a.extend([], E), G.push(G[0]));
                for (var H in F) {
                  for (var I = 0; I < G.length; I++) {
                    var J = 0 == H ? I : E.length - I - 1,
                      K = s.x + F[H] * Math.cos(G[J]),
                      L = s.y + F[H] * Math.sin(G[J]);
                    t += "" == t ? "M " : " L", t += a.jqx._ptrnd(K) + "," + a.jqx._ptrnd(L)
                  }
                  if (0 == H) {
                ...
                t += " Z", k = this.renderer.path(t)
              } else k = this.renderer.pieslice(s.x, s.y, z, A, B, C)
            }
          } else {
            var M = {
              x: Math.min(o, p),
            ...
            if (d || (M = {
              ...
              var D = M.x;
              M.x = M.y, M.y = D, D = M.width, M.width = M.height, M.height = D
            }
          ...
          isNaN(P) && (P = 1);
          var Q = l.opacity;
          (isNaN(Q) || Q < 0 || Q > 1) && (Q = 1), this.renderer.attr(k, {
            fill: N,
            "fill-opacity": Q,
            stroke: O,
            "stroke-opacity": Q,
    ...
    _getColumnGroupWidth: function(a, b, c) {
      var d = this.seriesGroups[a],
        ...
        f = (e || d.series.length, this._getColumnGroupsCount(d.orientation));
      (isNaN(f) || 0 == f) && (f = 1);
      var g = b.rangeLength >= 1 ? b.itemWidth : .9 * c,
        h = d.columnsMinWidth;
      isNaN(h) && (h = 1), isNaN(d.columnsMaxWidth) || (h = Math.min(d.columnsMaxWidth, h)), h > g && b.length > 0 && (g = Math.max(g, .9 * c / b.length));
      var i = h;
      if (!e) {
        var j = d.seriesGapPercent;
        (isNaN(j) || j < 0) && (j = 10), j /= 100;
        var k = h;
        k *= 1 + j, i += d.series.length * k
      }
      return {
        requiredWidth: i,
        availableWidth: g,
    ...
    _getColumnSerieWidthAndOffset: function(a, b) {
      var c = this.seriesGroups[a],
        d = (c.series[b], "horizontal" == c.orientation),
        e = this._plotRect;
      d && (e = {
        x: e.y,
        y: e.x,
      ...
      if (f && 0 != f.xoffsets.length) {
        ...
        var h = this._getColumnGroupIndex(a),
          ...
          j = 0,
          k = i.targetWidth;
        (1 == this.columnSeriesOverlap || Math.round(k) > Math.round(i.availableWidth / g)) && (g = 1, h = 0), j -= k * g / 2, j += k * h;
        var l = c.columnsGapPercent;
        l <= 0 && (l = 0), (isNaN(l) || l >= 100) && (l = 25), l /= 100;
        var m = k * l;
        m + i.requiredWidth > i.targetWidth && (m = Math.max(0, i.targetWidth - i.requiredWidth)), Math.round(k) > Math.round(i.availableWidth) && (m = 0), k -= m, j += m / 2;
        ...
        c.series.length > 1 && r > k - 1 * c.series.length && (r = k - 1 * c.series.length, q = r / Math.max(1, c.series.length - 1));
        var s = p - r / c.series.length,
          t = 0,
          u = c.columnsMaxWidth;
        isNaN(u) || s > u && (t = s - u, s = u);
        var v = 0;
        if (o) v = t / 2;
        else {
    ...
    _renderColumnSeries: function(b, c) {
      ...
      if (d.series && 0 != d.series.length) {
        var e = (this._getDataLen(b), "horizontal" == d.orientation),
          f = c;
        e && (f = {
          x: c.y,
          y: c.x,
        ...
        if (g && 0 != g.xoffsets.length) {
          ...
          for (var j = this._getGroupGradientType(b), k = 0; k < d.series.length; k++) {
            var l = d.series[k];
            if (!l.customDraw) {
              var m = (l.dataField, this._getAnimProps(b, k)),
              ...
              if (a.isFunction(l.colorFunction) && !h)
                for (var t = g.xoffsets.first; t <= g.xoffsets.last; t++) s.push(this._getColors(b, k, t, j, 4));
              var u = {
                seriesIndex: k,
                serieColors: r,
                itemsColors: s,
    ...
    _getPercent: function(a, b, c, d) {
      return isNaN(a) && (a = b), !isNaN(c) && !isNaN(a) && a < c && (a = c), !isNaN(d) && !isNaN(a) && a > d && (a = d), isNaN(a) ? NaN : a
    },
    _getColumnVOffsets: function(a, b, c, d, e, f) {
      ...
      for (var j = this._getPercent(g.columnsNeckHeightPercent, NaN, 0, 100) / 100, k = this._getPercent(g.columnsNeckWidthPercent, 100, 0, 100) / 100, l = [], m = NaN, n = 0; n < c.length; n++) {
        var o, p = c[n],
          q = p.seriesIndex,
          r = (g.series[q], a.offsets[q][d].from),
          s = a.offsets[q][d].to,
          t = a.xoffsets.data[d],
          u = p.isVisible;
        u || (s = r);
        ...
        if (u && v && v.length > b && v[b].series.length > q) {
          ...
          o = v[b].series[q][w], !o || isNaN(o.from) || isNaN(o.to) || (r = o.from + (r - o.from) * f, s = o.to + (s - o.to) * f, t = o.xoffset + (t - o.xoffset) * f)
        }
        o || (s = r + (s - r) * (e ? 1 : f)), isNaN(r) && (r = isNaN(m) ? a.baseOffset : m), m = !isNaN(s) && e ? s : r, isNaN(s) && (s = r);
        var x = {
          from: r,
          to: s,
          xOffset: t
        };
        100 == h && 100 == i || (x.funnel = !0, x.toWidthPercent = h, x.fromWidthPercent = i), l.push(x)
      }
      if (e && l.length > 1 && !(this._elementRenderInfo && this._elementRenderInfo.length > b)) {
        for (var y = 0, z = 0, A = -1 / 0, B = 1 / 0, C = 1 / 0, D = -1 / 0, E = 0; E < l.length; E++) {
          var p = c[E];
          p.isVisible && (l[E].to >= l[E].from ? (z += l[E].to - l[E].from, C = Math.min(C, l[E].from), D = Math.max(D, l[E].to)) : (y += l[E].from - l[E].to, A = Math.max(A, l[E].from), B = Math.min(B, l[E].to)))
        }
        var F = y,
          G = z;
        y *= f, z *= f;
        for (var H = 0, I = 0, E = 0; E < l.length; E++)
          if (l[E].to >= l[E].from) {
            ...
            J + I > z && (J = Math.max(0, z - I), l[E].to = l[E].from + J), 100 == h && 100 == i || (l[E].funnel = !0, !isNaN(j) && G * j >= I ? l[E].fromWidthPercent = 100 * k : l[E].fromWidthPercent = Math.abs(l[E].from - C) / G * (h - i) + i, !isNaN(j) && G * j >= 0 + (I + J) ? l[E].toWidthPercent = 100 * k : l[E].toWidthPercent = Math.abs(l[E].to - C) / G * (h - i) + i), I += J
          } else {
            var J = l[E].from - l[E].to;
            J + H > y && (J = Math.max(0, y - H), l[E].to = l[E].from - J), 100 == h && 100 == i || (l[E].funnel = !0, !isNaN(j) && F * j >= H ? l[E].fromWidthPercent = 100 * k : l[E].fromWidthPercent = Math.abs(l[E].from - A) / F * (h - i) + i, !isNaN(j) && F * j >= 0 + (H + J) ? l[E].toWidthPercent = 100 * k : l[E].toWidthPercent = Math.abs(l[E].to - A) / F * (h - i) + i), H += J
          }
      }
      return l
    },
    _columnAsPieSlice: function(b, c, d, e) {
      var f = this._toPolarCoord(d, c, e.x, e.y),
        ...
        n = d.startAngle;
      if (n = 360 * n / (2 * Math.PI), l -= n, m -= n, b)
        if (void 0 != b.element) {
          var o = this.renderer.pieSlicePath(d.x, d.y, h, i, m, l, 0);
          o += " Z", this.renderer.attr(b.element, {
            d: o
          })
        } else b.element = this.renderer.pieslice(d.x, d.y, h, i, m, l, 0);
      return {
        fromAngle: m,
        toAngle: l,
        innerRadius: h,
    ...
    _animColumns: function(b, c) {
      for (var d = this, e = b.groupIndex, f = this.seriesGroups[e], g = b.renderData, h = -1 != f.type.indexOf("waterfall"), i = this._getXAxis(e), j = -1 != f.type.indexOf("stacked"), k = b.polarAxisCoords, l = (this._getGroupGradientType(e), b.columnGroupWidth.targetWidth, -1), m = 0; m < f.series.length; m++)
      ...
      for (var n = NaN, o = NaN, m = 0; m < b.seriesCtx.length; m++) {
        var p = b.seriesCtx[m];
        (isNaN(n) || n > p.xAdjust) && (n = p.xAdjust), (isNaN(o) || o < p.xAdjust + p.columnWidth) && (o = p.xAdjust + p.columnWidth)
      }
      var q = Math.abs(o - n),
      ...
      for (var s = r * q, t = b.renderData.xoffsets, u = -1, v = {}, w = 1 == f.skipOverlappingPoints, x = t.first; x <= t.last; x++) {
        ...
        if (!isNaN(y) && !(-1 != u && Math.abs(y - u) < q - 1 + s && w)) {
          ...
          var z = this._getColumnVOffsets(g, e, b.seriesCtx, x, j, c),
            A = !1;
          if (h)
            for (var B = 0; B < f.series.length; B++) f.series[B].summary && t.xvalues[x][f.series[B].summary] && (A = !0);
          for (var B = 0; B < b.seriesCtx.length; B++) {
            ...
            if (K) {
              ...
              z[B].funnel && (L.fromWidthPercent = z[B].fromWidthPercent, L.toWidthPercent = z[B].toWidthPercent);
              var M = !0;
              b.vertical ? (L.y = E, L.height = F - E, L.height < 0 && (L.y += L.height, L.height = -L.height, M = !1)) : (L.x = E < F ? E : F, L.width = Math.abs(E - F), M = E - F < 0, L.y = y, L.height = p.columnWidth);
              var N = E - F;
              if (!isNaN(N)) {
                N = Math.abs(N);
                var O = void 0,
                  ...
                  R = P.labelElement,
                  S = void 0 == Q;
                if (R && (d.renderer.removeElement(R), R = void 0), k) {
                  var T = {
                    element: Q
                  };
                  O = this._columnAsPieSlice(T, b.rect, k, L), Q = T.element;
                ...
                } else S ? Q = this.renderer.rect(L.x, L.y, b.vertical ? L.width : 0, b.vertical ? 0 : L.height) : 1 == b.vertical ? this.renderer.attr(Q, {
                  x: L.x,
                  y: L.y,
                  height: N
                ...
                if (N < 1 && (1 != c || k) ? this.renderer.attr(Q, {
                  ...
                  }), R && this.renderer.removeElement(R), !K || 0 == N && c < 1) P = {
                  element: Q,
                  labelElement: R
                    ...
                    if (!j || j && B == l) {
                      ...
                      if (1 == c && !isNaN(g.offsets[B][x].from) && !isNaN(g.offsets[B][x].to)) {
                        ...
                        if (void 0 != W) {
                          ...
                          b.vertical || (this._swapXY([X]), this._swapXY([Y])), this.renderer.line(X.x, X.y, Y.x, Y.y, {
                            stroke: W.color,
                            "stroke-width": I.stroke,
                            "stroke-opacity": I.opacity,
                            "fill-opacity": I.opacity,
                  ...
                  if (k) {
                    var _ = (this._toPolarCoord(k, b.rect, L.x + L.width / 2, L.y), this._showLabel(e, C, x, L, void 0, void 0, !0)),
                      ba = O.outerRadius + 10;
                    labelOffset = this._adjustTextBoxPosition(k.x, k.y, _, ba, (O.fromAngle + O.toAngle) / 2, !0, !1, !1), R = this._showLabel(e, C, x, {
                      x: labelOffset.x,
                      y: labelOffset.y
                    }, void 0, void 0, !1, !1, !1)
                  } else R = this._showLabel(e, C, x, L, void 0, void 0, !1, !1, M);
                  P = {
                    element: Q,
                    labelElement: R
                  }, d._setRenderInfo(e, C, x, P), 1 == c && this._installHandlers(Q, "column", e, C, x)
                }
              }
            }
          }
    ...
    _getTrapezoidPath: function(b, c, d) {
      ...
      if (!c) {
        var h = b.width;
        b.width = b.height, b.height = h, h = b.x, b.x = b.y, b.y = h
      }
      var i = b.x + b.width / 2,
        j = [{
          x: i - b.width * (d ? g : f) / 2,
      ...
      c || this._swapXY(j), e += "M " + a.jqx._ptrnd(j[0].x) + "," + a.jqx._ptrnd(j[0].y);
      for (var k = 1; k < j.length; k++) e += " L " + a.jqx._ptrnd(j[k].x) + "," + a.jqx._ptrnd(j[k].y);
      return e += " Z"
    },
    _swapXY: function(a) {
      for (var b = 0; b < a.length; b++) {
    ...
    _renderCandleStickSeries: function(b, c, d) {
      ...
      if (f.series && 0 != f.series.length) {
        ...
        if (i && 0 != i.xoffsets.length) {
          var j;
          h.width;
          (f.polar || f.spider) && (j = e._getPolarAxisCoords(b, h), 2 * j.r);
          for (var k = (e._alignValuesWithTicks(b), e._getGroupGradientType(b)), l = [], m = 0; m < f.series.length; m++) l[m] = e._getColumnSerieWidthAndOffset(b, m);
    ...
    _animCandleStick: function(b, c) {
      ...
      for (var j = NaN, k = NaN, l = 0; l < b.columnsInfo.length; l++) {
        ...
        (isNaN(j) || j > m.offset) && (j = m.offset), (isNaN(k) || k < m.offset + m.width) && (k = m.offset + m.width)
      }
      for (var n = Math.abs(k - j), o = 0 != f.skipOverlappingPoints, p = g.first; p <= g.last; p++) {
        var q = g.data[p];
        if (!isNaN(q) && !(-1 != h && Math.abs(q - h) < n && o)) {
          if (Math.abs(g.data[p] - g.data[g.first]) > i) break;
          h = q;
          ...
          if (q += b.inverse ? b.rect.y : b.rect.x, b.polarAxisCoords) {
            var u = this._toPolarCoord(b.polarAxisCoords, this._plotRect, q, t);
            q = u.x, t = u.y
          }
          q = a.jqx._ptrnd(q);
          for (var v in d) r[v] = a.jqx._ptrnd(r[v]);
          var w = b.colors;
          if (w || (w = b.self._getColors(b.groupIndex, b.seriesIndex, p, b.gradientType)), b.isOHLC) {
            ...
            var y = r.lineElement;
            y || (y = this.renderer.path(x, {}), this.renderer.attr(y, {
              fill: w.fillColor,
            ...
            }), r.lineElement = y), 1 == c && this._installHandlers(y, "column", b.groupIndex, b.seriesIndex, p)
          } else {
            var y = r.lineElement;
            y || (y = b.inverse ? this.renderer.line(r.Low, q, r.High, q) : this.renderer.line(q, r.Low, q, r.High), this.renderer.attr(y, {
              fill: w.fillColor,
              "fill-opacity": b["fill-opacity"],
              "stroke-opacity": b["fill-opacity"],
              stroke: w.lineColor,
            ...
            if (q -= e / 2, !z) {
              var A = w.fillColor;
              r.Close <= r.Open && w.fillColorAlt && (A = w.fillColorAlt), z = b.inverse ? this.renderer.rect(Math.min(r.Open, r.Close), q, Math.abs(r.Close - r.Open), e) : this.renderer.rect(q, Math.min(r.Open, r.Close), e, Math.abs(r.Close - r.Open)), this.renderer.attr(z, {
                fill: A,
                "fill-opacity": b["fill-opacity"],
                "stroke-opacity": b["fill-opacity"],
                stroke: w.lineColor,
    ...
    _renderScatterSeries: function(b, c, d) {
      ...
      if (e.series && 0 != e.series.length) {
        ...
        if (i && 0 != i.xoffsets.length) {
          var j, k = h.width;
          (e.polar || e.spider) && (j = this._getPolarAxisCoords(b, h), k = 2 * j.r);
          var l = (this._alignValuesWithTicks(b), this._getGroupGradientType(b));
          d || (d = "to");
            ...
            if (!o.customDraw) {
              ...
              if (f)
                for (var u = i.xoffsets.first; u <= i.xoffsets.last; u++) {
                  ...
                  if ("number" != typeof v) throw "Invalid radiusDataField value at [" + u + "]";
                  isNaN(v) || ((isNaN(s) || v < s) && (s = v), (isNaN(t) || v > t) && (t = v))
                }
              var w = o.minRadius || o.minSymbolSize;
              isNaN(w) && (w = k / 50);
              var x = o.maxRadius || o.maxSymbolSize;
              isNaN(x) && (x = k / 25), w > x && (x = w);
              var y = o.radius;
                  ...
                  if (!(F < h.y || F > h.y + h.height || isNaN(D) || isNaN(F))) {
                    ...
                    if (!(!q && C && this.enableSampling && a.jqx._ptdist(C.x, C.y, D, F) < 1)) {
                      ...
                      if (f) {
                        ...
                        H = w + (x - w) * (I - s) / Math.max(1, t - s), isNaN(H) && (H = w)
                      }
                      ...
                      if (void 0 != E && M && M.length > b && M[b].series.length > m) {
                        ...
                        if (N && !isNaN(N.to)) {
                          if (J = N.to, K = N.xoffset, L = y, g) {
                            var G = K;
                            K = J, J = G + c.y
                          } else K += c.x;
                          f && (L = w + (x - w) * (N.valueRadius - s) / Math.max(1, t - s), isNaN(L) && (L = w))
                        }
                      }
                      q && (r = this._getColors(b, m, u, l)), B.items.push({
                        from: L,
                        to: H,
                        itemIndex: u,
                        fill: r.fillColor,
    ...
    _animR: function(b, c) {
      for (var d = b.items, e = b.symbolType || "circle", f = b.symbolSize, g = 0; g < d.length; g++) {
        ...
        if (isNaN(h.yFrom) || (j = h.yFrom + (j - h.yFrom) * c), isNaN(h.xFrom) || (i = h.xFrom + (i - h.xFrom) * c), b.polarAxisCoords) {
          var l = this._toPolarCoord(b.polarAxisCoords, this._plotRect, i, j);
          i = l.x, j = l.y
        }
        i = a.jqx._ptrnd(i), j = a.jqx._ptrnd(j), k = a.jqx._ptrnd(k);
        var m = this._getRenderInfo(b.groupIndex, b.seriesIndex, d[g].itemIndex),
          n = m.element,
          o = m.labelElement;
        "circle" == e ? (n || (n = this.renderer.circle(i, j, k), this.renderer.attr(n, {
          fill: h.fill,
          "fill-opacity": b["fill-opacity"],
          "stroke-opacity": b["fill-opacity"],
          stroke: h.stroke,
          ...
          cy: j,
          cx: i
        })) : (n && this.renderer.removeElement(n), n = this._drawSymbol(e, i, j, h.fill, b["fill-opacity"], h.stroke, b["stroke-opacity"] || b["fill-opacity"], b["stroke-width-symbol"], b["stroke-dasharray"], f || k)), o && this.renderer.removeElement(o), o = this._showLabel(b.groupIndex, b.seriesIndex, h.itemIndex, {
          x: i - k,
          y: j - k,
          width: 2 * k,
          height: 2 * k
        }), c >= 1 && this._installHandlers(n, "circle", b.groupIndex, b.seriesIndex, h.itemIndex), this._setRenderInfo(b.groupIndex, b.seriesIndex, d[g].itemIndex, {
          element: n,
          labelElement: o
        })
      }
    ...
    _showToolTip: function(b, c, d, e, f) {
      ...
      if (!g._ttEl || d != g._ttEl.gidx || e != g._ttEl.sidx || f != g._ttEl.iidx) {
        ...
        g._pointMarker ? (b = parseInt(g._pointMarker.x + 5), c = parseInt(g._pointMarker.y - 5)) : l = !1;
        var m = l && 0 == g.showToolTips;
        b = a.jqx._ptrnd(b), c = a.jqx._ptrnd(c);
        g._ttEl;
        if (0 != j.showToolTips && 0 != k.showToolTips) {
          ...
          void 0 != h.dataField && "" != h.dataField || (q = f), "date" == h.type && (q = g._castAsDate(q, (n ? n.dateFormat : void 0) || h.dateFormat));
          var r = "";
          if (a.isFunction(o)) {
            var s = {},
              t = 0;
            for (var u in k) 0 == u.indexOf("dataField") && (s[u.substring(9, u.length).toLowerCase()] = g._getDataValue(f, k[u], d), t++);
            0 == t ? s = g._getDataValue(f, void 0, d) : 1 == t && (s = s[""]), r = o(s, f, k, j, q, h)
          } else {
            ...
            if (g._isPieGroup(d)) q = g._getDataValue(f, k.displayText || k.dataField, d), y = g._formatValue(q, w, x, d, e, f), r = y + ": " + r;
            else {
              var z = h.displayText || h.dataField || "";
              r = z.length > 0 ? z + ": " + y + "<br>" + r : y + "<br>" + r
            }
          }
          if (g._ttEl || (g._ttEl = {}), g._ttEl.sidx = e, g._ttEl.gidx = d, g._ttEl.iidx = f, rect = g.renderer.getRect(), l) {
            ...
            if (j.polar || j.spider) {
              ...
              if (a.jqx._ptdist(A, B, D.x, D.y) > D.r) return;
            ...
            } else g._ttEl.vLine && g._ttEl.hLine ? (g.renderer.attr(g._ttEl.vLine, {
              x1: A,
              x2: A
          ...
          if (!m && 0 != g.showToolTips) {
            var H = k.toolTipClass || j.toolTipClass || this.toThemeProperty("jqx-chart-tooltip-text", null),
              ...
              M = 0;
            g._pointMarker && g._pointMarker.element && (M = k.symbolSizeSelected, isNaN(M) && (M = k.symbolSize), (isNaN(M) || M > 50 || M < 0) && (M = j.symbolSize), (isNaN(M) || M > 50 || M < 0) && (M = 8)), g._createTooltip(L, j, r, {
              css: H,
              fill: I,
              stroke: J,
              fillOpacity: K,
    ...
    _createTooltip: function(b, c, d, e) {
      var f = this,
        ...
        i = f._ttEl.box;
      if (!i) {
        h = !0, i = f._ttEl.box = document.createElement("div");
        i.style.position = "absolute", i.style.cursor = "default", a(j).css({
          "z-index": 1e7,
        ...
        j.id = "arrowOuterDiv", j.style.width = "0px", j.style.height = "0px", j.style.position = "absolute", a(j).css({
          "z-index": 1e7 + 1,
          "box-sizing": "content-box"
        });
        var k = document.createElement("div");
        k.id = "arrowInnerDiv", k.style.width = "0px", k.style.height = "0px", k.style.position = "absolute";
        var l = document.createElement("div");
        l.id = "contentDiv", l.style.position = "absolute", a(l).css({
          "box-sizing": "content-box"
        }), a(l).addClass("jqx-rc-all jqx-button"), a(l).appendTo(a(i)), a(j).appendTo(a(i)), a(k).appendTo(a(i)), a(k).css({
          "z-index": 1e7 + 2,
          "box-sizing": "content-box"
        })
      }
      if (!d || 0 == d.length) return void a(i).fadeTo(0, 0);
      l = a(i).find("#contentDiv")[0], j = a(i).find("#arrowOuterDiv")[0], k = a(i).find("#arrowInnerDiv")[0], k.style.opacity = j.style.opacity = e.fillOpacity, l.style.backgroundColor = e.fill, l.style.borderColor = e.stroke, l.style.opacity = e.fillOpacity;
      var m = "<span class='" + e.css + "'>" + d + "</span>";
      a(l).html(m);
      var n = this._measureHtml(m, "jqx-rc-all jqx-button");
      if (rect = f._plotRect, !(n.width > rect.width || n.height > rect.height)) {
        var o = {
          width: n.width,
          height: n.height
        };
        ...
        if (x = Math.max(b.x, rect.x), y = Math.max(b.y, rect.y), "dataPoint" == f.toolTipAlignment) {
          if (-1 != g.indexOf("pie") || -1 != g.indexOf("donut")) {
            ...
            x = b.x = b.center.x + Math.cos(q) * r, y = b.y = b.center.y - Math.sin(q) * r, b.width = b.height = 1
          } else p && (c.polar || c.spider) && (b.width = b.height = 1);
          var s = this._fitTooltip(this._plotRect, b, o, c, e.symbolSize);
          "" != s.arrowLocation && (arrowLocation = s.arrowLocation, x = s.x, y = s.y, o.width = s.width, o.height = s.height)
        } else arrowLocation = "";
        "top" == arrowLocation || "bottom" == arrowLocation ? (o.height += 7, x -= 3.5, "bottom" == arrowLocation && (y -= 7)) : "left" != arrowLocation && "right" != arrowLocation || (o.width += 7, y -= 3.5, "right" == arrowLocation && (x -= 7)), x + o.width > rect.x + rect.width && (arrowLocation = "", x = rect.x + rect.width - o.width), y + o.height > rect.y + rect.height && (arrowLocation = "", y = rect.y + rect.height - o.height);
        var t = {
          x: 0,
          y: 0
        };
        a(l).css({
          ...
          left: 0,
          top: 0
        }), j.style["margin-top"] = j.style["margin-left"] = 0, k.style["margin-top"] = k.style["margin-left"] = 0, l.style["margin-top"] = l.style["margin-left"] = 0;
        switch (arrowLocation) {
          case "left":
            t = {
              ...
              x: 7,
              y: 0
            }, l.style["margin-left"] = "7px", j.style["margin-left"] = "0px", j.style["margin-top"] = t.y + "px", j.style["border-left"] = "", j.style["border-right"] = "7px solid " + e.stroke, j.style["border-top"] = "7px solid transparent", j.style["border-bottom"] = "7px solid transparent", k.style["margin-left"] = "1px", k.style["margin-top"] = t.y + "px", k.style["border-left"] = "", k.style["border-right"] = "7px solid " + e.fill, k.style["border-top"] = "7px solid transparent", k.style["border-bottom"] = "7px solid transparent";
            break;
          case "right":
            t = {
              x: o.width - 7,
              ...
              x: 0,
              y: 0
            }, j.style["margin-left"] = t.x + "px", j.style["margin-top"] = t.y + "px", j.style["border-left"] = "7px solid " + e.stroke, j.style["border-right"] = "", j.style["border-top"] = "7px solid transparent", j.style["border-bottom"] = "7px solid transparent", k.style["margin-left"] = t.x - 1 + "px", k.style["margin-top"] = t.y + "px", k.style["border-left"] = "7px solid " + e.fill, k.style["border-right"] = "", k.style["border-top"] = "7px solid transparent", k.style["border-bottom"] = "7px solid transparent";
            break;
          case "top":
            t = {
              x: o.width / 2 - 3.5,
              ...
              x: 0,
              y: 7
            }, l.style["margin-top"] = contentPostion.y + "px", j.style["margin-left"] = t.x + "px", j.style["border-top"] = "", j.style["border-bottom"] = "7px solid " + e.stroke, j.style["border-left"] = "7px solid transparent", j.style["border-right"] = "7px solid transparent", k.style["margin-left"] = t.x + "px", k.style["margin-top"] = "1px", k.style["border-top"] = "", k.style["border-bottom"] = "7px solid " + e.fill, k.style["border-left"] = "7px solid transparent", k.style["border-right"] = "7px solid transparent";
            break;
          case "bottom":
            t = {
              x: o.width / 2 - 3.5,
              ...
              x: 0,
              y: 0
            }, j.style["margin-left"] = t.x + "px", j.style["margin-top"] = t.y + "px", j.style["border-top"] = "7px solid " + e.stroke, j.style["border-bottom"] = "", j.style["border-left"] = "7px solid transparent", j.style["border-right"] = "7px solid transparent", k.style["margin-left"] = t.x + "px", k.style["margin-top"] = t.y - 1 + "px", k.style["border-top"] = "7px solid " + e.fill, k.style["border-bottom"] = "", k.style["border-left"] = "7px solid transparent", k.style["border-right"] = "7px solid transparent"
        }
        "" == arrowLocation ? (a(j).hide(), a(k).hide()) : (a(j).show(), a(k).show()), a(i).css({
          width: o.width + "px",
          height: o.height + "px"
        });
        var u = f.host.coord();
        h && (a(i).fadeOut(0, 0), i.style.left = x + u.left + "px", i.style.top = y + u.top + "px"), a(i).clearQueue(), a(i).animate({
          left: x + u.left,
          top: y + u.top,
          opacity: 1
        }, f.toolTipMoveDuration, "easeInOutCirc"), a(i).fadeTo(400, 1)
      }
    },
    _measureHtml: function(b, c) {
      var d = this._measureDiv;
      d || (this._measureDiv = d = document.createElement("div"), d.style.position = "absolute", d.style.cursor = "default", d.style.overflow = "hidden", d.style.display = "none", a(d).addClass(c), this.host.append(d)), a(d).html(b);
      var e = {
        width: a(d).width() + 2,
        height: a(d).height() + 2
      };
      return a.jqx.browser && a.jqx.browser.mozilla && (e.height += 3), e
    },
    _hideToolTip: function(b) {
      this._ttEl && (this._ttEl.box && (0 == b ? a(this._ttEl.box).hide() : a(this._ttEl.box).fadeOut()), this._hideCrosshairs(), this._ttEl.gidx = void 0)
    },
    ...
    _getLabelsSettings: function(b, c, d, e) {
      for (var f = this.seriesGroups[b], g = f.series[c], h = isNaN(d) ? void 0 : this._getDataValue(d, g.dataField, b), i = e || ["Visible", "Offset", "Angle", "HorizontalAlignment", "VerticalAlignment", "Class", "BackgroundColor", "BorderColor", "BorderOpacity", "Padding", "Opacity", "BackgroundOpacity", "LinesAngles", "LinesEnabled", "AutoRotate", "Radius"], j = {}, k = 0; k < i.length; k++) {
        var l = i[k],
          ...
          p = void 0;
        f.labels && "object" == typeof f.labels && (p = f.labels[o]), g.labels && "object" == typeof g.labels && void 0 != g.labels[o] && (p = g.labels[o]), p = this._get([g[m], g[n], p, f[m], f[n]]), a.isFunction(p) ? j[o] = p(h, d, g, f) : j[o] = p
      }
      j.class = j.class || this.toThemeProperty("jqx-chart-label-text", null), j.visible = this._get([j.visible, g.showLabels, f.showLabels, void 0 != g.labels || void 0, void 0 != f.labels || void 0]);
      var q = j.padding || 1;
      return j.padding = {
    ...
    _showLabel: function(a, b, c, d, e, f, g, h, i, j, k) {
      ...
      if (!isNaN(c)) {
        ...
        if (!n.visible) return g ? m : void 0;
        if (d.width < 0 || d.height < 0) return g ? m : void 0;
        var o = n.angle;
        isNaN(j) || (o = j);
        var p = n.offset || {},
          q = {
        ...
        isNaN(q.x) && (q.x = 0), isNaN(q.y) && (q.y = 0), e = e || n.horizontalAlignment || "center", f = f || n.verticalAlignment || "center";
        var r = this._getFormattedValue(a, b, c, void 0, void 0, !0),
          s = d.width,
          t = d.height;
        if (1 == h && "center" != e && (e = "right" == e ? "left" : "right"), 1 == i && "center" != f && "middle" != f && (f = "top" == f ? "bottom" : "top", q.y *= -1), m = this.renderer.measureText(r, o, {
            class: n.class
          }), g) return m;
        var u = 0,
          v = 0;
        s > 0 && ("" == e || "center" == e ? u += (s - m.width) / 2 : "right" == e && (u += s - m.width)), t > 0 && ("" == f || "center" == f ? v += (t - m.height) / 2 : "bottom" == f && (v += t - m.height)), u += d.x + q.x, v += d.y + q.y;
        var w = this._plotRect;
        u <= w.x && (u = w.x + 2), v <= w.y && (v = w.y + 2);
        var x = {
          width: Math.max(m.width, 1),
          height: Math.max(m.height, 1)
        };
        v + x.height >= w.y + w.height && (v = w.y + w.height - x.height - 2), u + x.width >= w.x + w.width && (u = w.x + w.width - x.width - 2);
        var y, z = n.backgroundColor,
          A = n.borderColor,
          B = n.padding;
        if (z || A) {
        ...
        return k && (k.x = u - B.left, k.y = v - B.top, k.width = m.width + B.left + B.right, k.height = m.height + B.bottom + B.bottom), this._isVML && (this.renderer.removeElement(C), this.renderer.getContainer()[0].appendChild(C)), y && this.renderer.endGroup(), y || C
      }
    },
    _getAnimProps: function(a, b) {
      ...
      c.enableAnimations && (e = 1 == c.enableAnimations), d && d.enableAnimations && (e = 1 == d.enableAnimations);
    ...
    _isColorTransition: function(a, b, c, d) {
      if (d - 1 < c.xoffsets.first) return !1;
      ...
      if (d.series && 0 != d.series.length) {
        ...
        if (k && (i = !1), !i || !h) {
          var l = this._getDataLen(b),
            m = (c.width, "horizontal" == d.orientation),
          ...
          if (p && 0 != p.xoffsets.length) {
            this._linesRenderInfo || (this._linesRenderInfo = {}), this._linesRenderInfo[b] = {};
            for (var q = d.series.length - 1; q >= 0; q--) {
              ...
              if (this._isSerieVisible(b, q)) {
                var t = d.series[q];
                if (!t.customDraw) {
                  var u, v = a.isFunction(t.colorFunction),
                    w = p.xoffsets.first,
                    x = w,
                    y = this._getColors(b, q, NaN, this._getGroupGradientType(b));
                  do {
                    var z = [],
                      A = [],
                      B = [],
                    ...
                    if (!(p.xoffsets.length < 1)) {
                      var H = this._getAnimProps(b, q),
                        ...
                        J = w;
                      u = !1;
                      for (var K = (this._getColors(b, q, w, this._getGroupGradientType(b)), void 0), L = w; L <= p.xoffsets.last; L++) {
                        w = L;
                        var M = p.xoffsets.data[L],
                          N = p.xoffsets.xvalues[L];
                        if (!isNaN(M) && (M = Math.max(M, 1), C = M, D = p.offsets[q][L].to, !(!v && K && this.enableSampling && a.jqx._ptdist(K.x, K.y, C, D) < 1))) {
                          K = {
                            x: C,
                            y: D
                          };
                          ...
                          if (isNaN(D) || isNaN(O)) {
                            if ("connect" == t.emptyPointsDisplay) continue;
                            if ("zero" != t.emptyPointsDisplay) {
                              u = !0;
                              break
                            }
                            isNaN(D) && (D = p.baseOffset), isNaN(O) && (O = p.baseOffset)
                          }
                          ...
                          x = L, r.stroke < 2 && (D - o.y <= 1 && (D = o.y + 1), O - o.y <= 1 && (O = o.y + 1), o.y + o.height - D <= 1 && (D = o.y + o.height - 1), o.y + o.height - O <= 1 && (O = o.y + o.height - 1)), !e && g && (D <= o.y && (D = o.y + 1), D >= o.y + o.height && (D = o.y + o.height - 1), O <= o.y && (O = o.y + 1), O >= o.y + o.height && (O = o.y + o.height - 1)), M = Math.max(M, 1), C = M + o.x, 1 == d.skipOverlappingPoints && !isNaN(E) && Math.abs(E - C) <= 1 || (!i || isNaN(E) || isNaN(F) || F != D && z.push(m ? {
                            y: C,
                            x: a.jqx._ptrnd(F)
                          } : {
                            x: C,
                      ...
                      if (0 != z.length) {
                        ...
                        if (e && 1 == d.alignEndPointsWithIntervals) {
                          if (T > o.x && (T = o.x), U < o.x + o.width && (U = o.x + o.width), n) {
                            var V = T;
                            T = U, U = V
                          }
                        }
                        U = a.jqx._ptrnd(U), T = a.jqx._ptrnd(T);
                        var W = p.baseOffset;
                        G = a.jqx._ptrnd(G);
                        var X = a.jqx._ptrnd(D) || W;
                        j && (z = z.concat(A.reverse())), s.pointsLength += z.length;
                        var Y = {
                          lastItemIndex: S,
                          colorSettings: y,
                          pointsArray: z,
                  ...
                  } while (w < p.xoffsets.first + p.xoffsets.length - 1 || u);
                  this._linesRenderInfo[b][q] = s
                }
              } else this._linesRenderInfo[b][q] = s
            }
            var Z = this._linesRenderInfo[b],
              $ = [];
            for (var L in Z) $.push(Z[L]);
            $ = $.sort(function(a, b) {
      ...
      for (var k = 0, l = 0; l < a.segments.length; l++) {
        ...
        if (k += m.pointsArray.length, "" != n) {
          ...
          if (m.pathElement ? this.renderer.attr(m.pathElement, {
            ...
            }), this._installHandlers(m.pathElement, "path", d, e, m.lastItemIndex)), m.labelElements) {
            for (var r = 0; r < m.labelElements.length; r++) this.renderer.removeElement(m.labelElements[r]);
            m.labelElements = []
          }
          if (m.symbolElements) {
            for (var r = 0; r < m.symbolElements.length; r++) this.renderer.removeElement(m.symbolElements[r]);
            m.symbolElements = []
          }
          ...
          if (1 == b && "none" != h)
            for (var r = 0; r < m.symbolElements.length; r++) isNaN(m.pointsArray[r].index) || this._installHandlers(m.symbolElements[r], "symbol", d, e, m.pointsArray[r].index)
        }
      }
    },
    ...
    _calculateLine: function(b, c, d, e, f, g, h, i, j) {
      ...
      for (var o = 0; o < n + 1 && o < e.length; o++) {
        ...
        var p = e[o].y,
          ...
          r = i ? g : p,
          s = q;
        if (f && f.length > o && (r = f[o].y, s = f[o].x, (isNaN(r) || isNaN(s)) && (r = p, s = q)), s, n <= e.length && o > 0 && o == n && (s = e[o - 1].x, r = e[o - 1].y), j ? (q = a.jqx._ptrnd((q - r) * (i ? h : 1) + r), p = a.jqx._ptrnd(p)) : (q = a.jqx._ptrnd((q - s) * h + s), p = a.jqx._ptrnd((p - r) * h + r)), k) {
    ...
    _buildLineCmd: function(a, b, c, d, e, f, g, h, i, j, k, l) {
      var m = a,
        n = l ? g + "," + c : c + "," + g,
        o = l ? g + "," + d : d + "," + g;
      !h || i || b || (m = n + " " + a + " " + o), k && (m = this._getBezierPoints(m));
      var p = m.split(" ");
      ...
      var r = p[0].replace("M", "");
      return h && !i ? m = b ? "M " + r + " L " + r + (k ? "" : " L " + r + " ") + m : "M " + n + " L " + r + " " + m : k || (m = "M " + r + " L " + r + " " + m), (i && j || b) && (m += " Z"), m
    },
    _getSerieSettings: function(a, b) {
      ...
      (isNaN(h) || h < 0 || h > 1) && (h = 1);
      var i = f.lineWidth;
      isNaN(i) && "auto" != i && (i = c.lineWidth), ("auto" == i || isNaN(i) || i < 0 || i > 15) && (i = d ? 2 : e ? 3 : 1);
    ...
    _getColors: function(b, c, d, e, f) {
      ...
      j.fillColor || (j.fillColor = t, j.fillColorSelected = a.jqx.adjustColor(t, 1.1), j.fillColorAlt = a.jqx.adjustColor(t, 4), j.fillColorAltSelected = a.jqx.adjustColor(t, 3), j.lineColor = j.symbolColor = a.jqx.adjustColor(t, .9), j.lineColorSelected = j.symbolColorSelected = a.jqx.adjustColor(t, .9));
      var k = [
          [0, 1.4],
          [100, 1]
        ],
        ...
        n = NaN;
      if (isNaN(f) || (n = 2 == f ? k : l), i) {
        var o = {};
        for (var p in j) o[p] = j[p];
        if (j = o, "verticalLinearGradient" == e || "horizontalLinearGradient" == e) {
          ...
          var u, n = k;
          ("pie" == g.type || "donut" == g.type || g.polar) && void 0 != d && this._renderData[b] && this._renderData[b].offsets[c] && (u = this._renderData[b].offsets[c][d], n = m), j.fillColor = this.renderer._toRadialGradient(j.fillColor, n, u), j.fillColorSelected = this.renderer._toRadialGradient(j.fillColorSelected, n, u)
        }
      }
      return j
    },
    _installHandlers: function(a, b, c, d, e) {
      if (!this.enableEvents) return !1;
      var f = this,
      ...
      i || 0 == g.enableSelection || 0 == h.enableSelection || (this.renderer.addHandler(a, "mousemove", function(a) {
        ...
        if (!b || !b.isLineType || "click" != b.linesUnselectMode || b.group == c && b.series == d) {
          var g = a.pageX || a.clientX || a.screenX,
            ...
            i = f.host.offset();
          g -= i.left, h -= i.top, f._mouseX == g && f._mouseY == h || f._ttEl && f._ttEl.gidx == c && f._ttEl.sidx == d && f._ttEl.iidx == e || f._startTooltipTimer(c, d, e)
        }
        ...
        clearTimeout(f._hostClickTimer), f._lastClickTs = (new Date).valueOf(), i && "symbol" != b && "pointMarker" != b || (f._isColumnType(g.type) && f._unselect(), isNaN(e) || (a.stopImmediatePropagation(), f._raiseItemEvent("click", g, h, e)))
      })
    },
    _getHorizontalOffset: function(b, c, d, e) {
      var f = this._plotRect;
      if (0 == this._getDataLen(b)) return {
        index: void 0,
        value: d
      };
      var g = this._calcGroupOffsets(b, this._plotRect);
      if (0 == g.xoffsets.length) return {
        index: void 0,
        value: void 0
      };
      var h, i = d,
        j = e,
        k = this.seriesGroups[b];
      (k.polar || k.spider) && (h = this._getPolarAxisCoords(b, f));
      for (var l, m, n, o, p = (this._getXAxis(b).flip, g.xoffsets.first); p <= g.xoffsets.last; p++) {
        var q = g.xoffsets.data[p],
          r = g.offsets[c][p].to,
          s = 0;
        if (h) {
          var t = this._toPolarCoord(h, f, q + f.x, r);
          q = t.x, r = t.y, s = a.jqx._ptdist(i, j, q, r)
        } else if ("horizontal" == k.orientation) {
          q += f.y;
          var u = r;
          r = q, q = u, s = a.jqx._ptdist(i, j, q, r)
        } else q += f.x, s = Math.abs(i - q);
        (isNaN(l) || l > s) && (l = s, m = p, n = q, o = r)
      }
      return {
        index: m,
    ...
    onmousemove: function(b, c) {
      if ((this._mouseX != b || this._mouseY != c) && (this._mouseX = b, this._mouseY = c, this._selected)) {
        var d = this._selected.group,
          e = this._selected.series,
          f = this.seriesGroups[d],
          g = f.series[e],
          h = this._plotRect;
        if (this.renderer && (h = this.renderer.getRect(), h.x += 5, h.y += 5, h.width -= 10, h.height -= 10), b < h.x || b > h.x + h.width || c < h.y || c > h.y + h.height) return this._hideToolTip(), void this._unselect();
        ...
        if (-1 != f.type.indexOf("line") || -1 != f.type.indexOf("area")) {
          ...
          if (this._selected.item != k) {
            ...
            var n = l[m].pathElement,
              o = l[m].lastItemIndex;
            this._unselect(!1), this._select(n, "path", d, e, k, o)
          }
          ...
          var q = this._calcGroupOffsets(d, h),
            ...
            s = r; - 1 != f.type.indexOf("range") && (s = q.offsets[this._selected.series][k].from);
          var t = i ? b : c;
          if (c = !isNaN(s) && Math.abs(t - s) < Math.abs(t - r) ? s : r, isNaN(c)) return;
          if (b = j.value, i) {
            var u = b;
            b = c, c = u + h.y
          } else b += h.x;
          if (j.polarAxisCoords && (b = j.x, c = j.y), c = a.jqx._ptrnd(c), b = a.jqx._ptrnd(b), this._pointMarker && this._pointMarker.element && (this.renderer.removeElement(this._pointMarker.element), this._pointMarker.element = void 0), isNaN(b) || isNaN(c)) return;
          var v = this._getSeriesColors(d, e, k),
            w = this._getSerieSettings(d, e),
            x = g.symbolSizeSelected;
          isNaN(x) && (x = g.symbolSize), (isNaN(x) || x > 50 || x < 0) && (x = f.symbolSize), (isNaN(x) || x > 50 || x < 0) && (x = 8), (this.showToolTips || this.enableCrosshairs) && (this._pointMarker = {
            type: p,
            x: b,
            y: c,
            gidx: d,
            sidx: e,
            iidx: k
          }, this._pointMarker.element = this._drawSymbol(p, b, c, v.fillColorSymbolSelected, w.opacity, v.lineColorSymbolSelected, w.opacity, w.strokeSymbol, w.dashStyle, x), this._installHandlers(this._pointMarker.element, "pointMarker", d, e, k)), this._startTooltipTimer(d, this._selected.series, k)
        }
      }
    },
    _drawSymbol: function(a, b, c, d, e, f, g, h, i, j) {
      ...
      switch (a) {
        ...
        case "circle":
          ...
          break;
        case "square":
          l -= 1, m = l / 2, k = this.renderer.rect(b - m, c - m, l, l);
          break;
        case "diamond":
    ...
    _getSymbol: function(a, b) {
      var c, d = ["circle", "square", "diamond", "triangle_up", "triangle_down", "triangle_left", "triangle_right"],
        e = this.seriesGroups[a],
        f = e.series[b];
      return void 0 != f.symbolType && (c = f.symbolType), void 0 == c && (c = e.symbolType), "default" == c ? d[b % d.length] : void 0 != c ? c : "none"
    },
    _startTooltipTimer: function(a, b, c, d, e, f, g) {
      this._cancelTooltipTimer();
      var h = this,
        i = (h.seriesGroups[a], this.toolTipShowDelay || this.toolTipDelay);
      (isNaN(i) || i > 1e4 || i < 0) && (i = 500), (this._ttEl || 1 == this.enableCrosshairs && 0 == this.showToolTips) && (i = 0), isNaN(f) || (i = f), clearTimeout(this._tttimerHide), isNaN(d) && (d = h._mouseX), isNaN(e) && (e = h._mouseY - 3), 0 == i && h._showToolTip(d, e, a, b, c), this._tttimer = setTimeout(function() {
        0 != i && h._showToolTip(d, e, a, b, c);
        var f = h.toolTipHideDelay;
        isNaN(g) || (f = g), isNaN(f) && (f = 4e3), h._tttimerHide = setTimeout(function() {
          h._hideToolTip(), h._unselect()
        }, f)
      }, i)
    },
    ...
    _select: function(a, b, c, d, e, f) {
      if (this._selected) {
        if (this._selected.item == e && this._selected.series == d && this._selected.group == c) return;
        this._unselect()
      }
      ...
      if (0 != g.enableSelection && 0 != h.enableSelection) {
        ...
        this.renderer.getAttr(a, "fill") == j.fillColorAlt && (k = j.fillColorAltSelected), this.renderer.attr(a, {
          stroke: m,
          fill: k,
          "stroke-width": n
        }), -1 == g.type.indexOf("pie") && -1 == g.type.indexOf("donut") || this._applyPieSelect(), this._raiseItemEvent("mouseover", g, h, e)
      }
    },
    _applyPieSelect: function() {
      ...
      if (b) {
        ...
        if (c) {
          ...
          }, e), a._startAnimation("animPieSlice")
        }
      }
    },
    ...
    _unselect: function() {
      ...
      if (a._selected) {
        ...
        k = "symbol" == f ? j.fillColorSymbol : k, this.renderer.getAttr(a._selected.element, "fill") == j.fillColorAltSelected && (k = j.fillColorAlt);
        var n = "symbol" == f ? 1 : l.stroke;
        a.renderer.attr(a._selected.element, {
          stroke: m,
          fill: k,
          "stroke-width": n
        }), -1 == g.type.indexOf("pie") && -1 == g.type.indexOf("donut") || this._applyPieUnselect(), a._selected = void 0, isNaN(d) || a._raiseItemEvent("mouseout", g, h, d)
      }
      a._pointMarker && (a._pointMarker.element && (a.renderer.removeElement(a._pointMarker.element), a._pointMarker.element = void 0), a._pointMarker = void 0, a._hideCrosshairs())
    },
    _raiseItemEvent: function(b, c, d, e) {
      ...
      if (g != this.seriesGroups.length) {
        ...
        f && a.isFunction(f) && f(h), this._raiseEvent(b, h)
      }
    },
    _raiseEvent: function(b, c) {
      var d = new a.Event(b);
      return d.owner = this, c.event = b, d.args = c, this.host.trigger(d)
    },
    _calcInterval: function(a, b, c) {
      ...
      do {
        j = 0, e >= 1 ? h *= 10 : h /= 10;
        for (var k = 1; k < i.length && Math.abs(i[j] * h - e) > Math.abs(i[k] * h - e); k++) j = k
      } while (j == i.length - 1);
      return i[j] * h
    },
      ...
      if (this._renderData && !this._isToggleRefresh) {
        ...
        if (!this._isSelectorRefresh)
          for (var b = 0; b < this._renderData.length; b++) {
            for (this._getXAxis(b).dataField; a.length <= b;) a.push({});
            var c = a[b],
            ...
            if (d.offsets) {
              if (d.valueAxis) {
                ...
                for (var e in d.valueAxis.itemOffsets) c.valueAxis.itemOffsets[e] = d.valueAxis.itemOffsets[e]
              }
              if (d.xAxis) {
                c.xAxis = {
                  itemOffsets: {}
                };
                for (var e in d.xAxis.itemOffsets) c.xAxis.itemOffsets[e] = d.xAxis.itemOffsets[e]
              }
              c.series = [];
    ...
    getXAxisDataPointOffset: function(a, b) {
      ...
      if (renderData = this._getXAxisRenderData(b), !renderData) return NaN;
      var d = renderData.data.axisStats,
        e = d.min.valueOf(),
        f = d.max.valueOf(),
        g = f - e;
      if (0 == g && (g = 1), a.valueOf() > f || a.valueOf() < e) return NaN;
    ...
    _getDataPointOffset: function(b, c, d, e, f, g) {
      var h;
      return isNaN(b) && (b = c), h = isNaN(d) ? (b - c) * e : (a.jqx.log(b, d) - a.jqx.log(c, d)) * e, this._isVML && (h = Math.round(h)), h = g ? f + h : f - h
    },
    _calcGroupOffsets: function(b, c) {
      for (var d = this.seriesGroups[b]; this._renderData.length < b + 1;) this._renderData.push({});
      if (null != this._renderData[b] && void 0 != this._renderData[b].offsets) return this._renderData[b];
      if (this._isPieGroup(b)) return this._calcPieSeriesGroupOffsets(b, c);
      var e = this._getValueAxis(b);
      if (!e || !d.series || 0 == d.series.length) return this._renderData[b];
      var f = 1 == e.flip,
      ...
      if (q && q.isValid) {
        ...
        p > q.max && (p = q.max), p < q.min && (p = q.min);
        var s = k || g ? q.maxRange : q.max - q.min,
          t = q.min,
          u = q.max,
          v = c.height / (g ? q.intervals : s),
          w = 0;
        k ? t * u < 0 ? (s /= 2, w = -(s + p) * v) : w = -p * v : w = -(p - t) * v, f ? w = c.y - w : w += c.y + c.height;
        var x, y = [],
          z = [],
          A = [];
        g && (x = a.jqx.log(u, h) - a.jqx.log(p, h), j && (x = q.intervals, p = k ? 0 : t), q.intervals - x, f || (w = c.y + x / q.intervals * c.height)), w = a.jqx._ptrnd(w);
        ...
        for (var G = 0; G < d.series.length; G++) i[G] = new Array(o);
        for (var H = 0; H < o; H++) {
          !n && j && (D = []);
          for (var G = 0; G < d.series.length; G++) {
            ...
            if (-1 == d.type.indexOf("candle") && -1 == d.type.indexOf("ohlc")) {
              ...
              if (j && (D[H] += N ? P : 0), N || (P = NaN), isNaN(P) || g && P <= 0) i[G][H] = {
                ...
                j && (E ? R = P >= p ? y : z : P = D[H]);
                var S = v * (P - p);
                if (l && (S = v * (P - O)), j && E && (F[H] ? S = v * P : (F[H] = !0, S = v * (P - p))), g) {
                  for (; C.length <= H;) C.push({
                    p: {
                      value: 0,
                      height: 0
                    },
                  ...
                  var T = l || l ? O : p,
                    U = P > T ? C[H].p : C[H].n;
                  U.value += P, k ? (P = U.value / (q.psums[H] + q.nsums[H]) * 100, S = (a.jqx.log(P, h) - q.minPow) * v) : (S = a.jqx.log(U.value, h) - a.jqx.log(T, h), S *= v), S -= U.height, U.height += S
                }
                var V = w;
                if (l) {
                  var W = 0;
                  W = g ? (a.jqx.log(O, h) - a.jqx.log(p, h)) * v : (O - p) * v, V += f ? W : -W
                }
                if (j) {
                  if (k && !g) {
                    var X = q.psums[H] - q.nsums[H];
                    P > p ? (S = q.psums[H] / X * B, 0 != q.psums[H] && (S *= P / q.psums[H])) : (S = q.nsums[H] / X * B, 0 != q.nsums[H] && (S *= P / q.nsums[H]))
                  }
                  E && (isNaN(R[H]) && (R[H] = V), V = R[H])
                }
                isNaN(A[H]) && (A[H] = 0);
                var Y = A[H];
                S = Math.abs(S);
                var Z = S;
                if (S >= 1 && (h_new = this._isVML ? Math.round(S) : a.jqx._ptrnd(S) - 1, S = Math.abs(S - h_new) > .5 ? Math.round(S) : h_new), Y += S - Z, j || (Y = 0), Math.abs(Y) > .5 && (Y > 0 ? (S -= 1, Y -= 1) : (S += 1, Y += 1)), A[H] = Y, G == d.series.length - 1 && k) {
                  for (var $ = 0, _ = 0; _ < G; _++) $ += Math.abs(i[_][H].to - i[_][H].from);
                  if (($ += S) < B)
                    if (S > .5) S = a.jqx._ptrnd(S + B - $);
                    else
                      for (var _ = G - 1; _ >= 0;) {
        ...
        return ga.baseOffset = w, ga.gbase = p, ga.logBase = g ? h : NaN, ga.scale = v, ga.offsets = n ? this._applyWaterfall(i, o, b, w, p, g ? h : NaN, v, f, j) : i, ga.xoffsets = this._calculateXOffsets(b, c.width), this._renderData[b]
      }
    },
    ...
    _calcPieSeriesGroupOffsets: function(b, c) {
      for (var d = this, e = this._getDataLen(b), f = this.seriesGroups[b], g = this._renderData[b] = {}, h = g.offsets = [], i = 0; i < f.series.length; i++) {
        ...
        var o = j.centerOffset || 0,
          ...
          s = n,
          t = j.radius;
        d._isPercent(t) && (t = parseFloat(t) / 100 * r), isNaN(t) && (t = .4 * r);
        var u = j.innerRadius;
        d._isPercent(u) && (u = parseFloat(u) / 100 * r), (isNaN(u) || u >= t) && (u = 0);
        var v = j.selectedRadiusChange;
        d._isPercent(v) && (v = parseFloat(v) / 100 * (t - u)), isNaN(v) && (v = .1 * (t - u)), h.push([]);
    ...
    _isPointSeriesOnly: function() {
      for (var a = 0; a < this.seriesGroups.length; a++) {
        var b = this.seriesGroups[a];
        if (-1 == b.type.indexOf("line") && -1 == b.type.indexOf("area") && -1 == b.type.indexOf("scatter") && -1 == b.type.indexOf("bubble")) return !1
      }
      return !0
    },
    _hasColumnSeries: function() {
      for (var a = ["column", "ohlc", "candlestick", "waterfall"], b = 0; b < this.seriesGroups.length; b++) {
        var c = this.seriesGroups[b];
        for (var d in a)
          if (-1 != c.type.indexOf(a[d])) return !0
      }
      return !1
    },
    _alignValuesWithTicks: function(a) {
      ...
      return d.logarithmicScale && (e = !0), void 0 == a ? e : void 0 == c.valuesOnTicks ? e : c.valuesOnTicks
    },
    ...
    _getDateDiff: function(b, c, d, e) {
      var f = 0;
      switch ("year" != d && "month" != d && (f = c.valueOf() - b.valueOf()), d) {
        case "year":
      ...
      return "year" != d && "month" != d && 0 != e && (f = a.jqx._rnd(f, 1, !0)), f
    },
    ...
    _getXAxisStats: function(b, c, d) {
      ...
      for (var l, m, n = h, o = i, p = void 0 == c.type || "auto" == c.type, q = p || "basic" == c.type, r = 0, s = 0, t = 0; t < e && c.dataField; t++) {
        ...
        u = f ? this._castAsDate(u, c.dateFormat) : this._castAsNumber(u), isNaN(u) || (f ? r++ : s++, (isNaN(l) || u < l) && (l = u), (isNaN(m) || u >= m) && (m = u))
      }
      p && (!f && s == e || f && r == e) && (q = !1), q && (l = 0, m = Math.max(0, e - 1)), isNaN(n) && (n = l), isNaN(o) && (o = m), f ? (this._isDate(n) || (n = this._isDate(o) ? o : new Date), this._isDate(o) || (o = this._isDate(n) ? n : new Date)) : (isNaN(n) && (n = 0), isNaN(o) && (o = q ? Math.max(0, e - 1) : n)), void 0 == l && (l = n), void 0 == m && (m = o);
      var v = c.rangeSelector;
      if (v) {
        var w = v.minValue || n;
        w && f && (w = this._castAsDate(w, v.dateFormat || c.dateFormat));
        var x = v.maxValue || o;
        x && f && (x = this._castAsDate(x, v.dateFormat || c.rangeSelector)), n < w && (n = w), o < w && (o = x), n > x && (n = w), o > x && (o = x)
      }
      var y, z, A = c.unitInterval;
      f && (y = c.baseUnit, y || (y = this._getBestDTUnit(n, o, b, d)),
      ...
      if (B) {
        n || (n = 1, o && n > o && (n = o)), o || (o = n), D = {
          min: n,
          max: o
        };
        var F = a.jqx._rnd(a.jqx.log(n, C), 1, !1),
          G = a.jqx._rnd(a.jqx.log(o, C), 1, !0);
        o = Math.pow(C, G), n = Math.pow(C, F)
      } else f || !E.polar && !E.spider || (n = a.jqx._rnd(n, A, !1), o = a.jqx._rnd(o, A, !0));
      return {
        min: n,
        max: o,
        logAxis: {
    ...
    _getDTIntCnt: function(a, b, c, d) {
      var e = 0,
        f = new Date(a),
        g = new Date(b);
      if (g = g.valueOf(), c <= 0) return 1;
      for (; f.valueOf() < g;) "millisecond" == d ? f = new Date(f.valueOf() + c) : "second" == d ? f = new Date(f.valueOf() + 1e3 * c) : "minute" == d ? f = new Date(f.valueOf() + 6e4 * c) : "hour" == d ? f = new Date(f.valueOf() + 6e4 * c * 24) : "day" == d ? f.setDate(f.getDate() + c) : "month" == d ? f.setMonth(f.getMonth() + c) : "year" == d && f.setFullYear(f.getFullYear() + c), e++;
      return e
    },
    _estAxisInterval: function(a, b, c, d, e, f) {
      ...
      if (i <= 1) return Math.abs(b - a);
      for (;;) {
        var k = h >= g.length ? Math.pow(10, 3 + h - g.length) : g[h];
        if ((this._isDate(a) && this._isDate(b) ? this._getDTIntCnt(a, b, k, e) : (b - a) / k) <= i) break;
        h++
      }
      var l = this.seriesGroups[c];
      return (l.spider || l.polar) && 2 * k > b - a && (k = b - a), k
    },
    _getPaddingSize: function(a, b, c, d, e, f, g) {
      var h = a.min,
        i = a.max;
      a.logAxis.enabled && (h = a.logAxis.minPow, i = a.logAxis.maxPow);
      var j = a.interval,
        k = a.dateTimeUnit;
      if (e) {
    ...
    _calculateXOffsets: function(b, c) {
      ...
      for (var x = -1, y = -1, z = 0; z < h; z++) {
        ...
        if (i.useIndeces) {
          if (z < v.min || z > v.max) {
            f.push(NaN), g.push(void 0);
            continue
          }
          if (C = t.left + (z - j) / u * w, 1 == i.logAxis.enabled) {
          ...
          f.push(a.jqx._ptrnd(C)), g.push(A), -1 == x && (x = z), (-1 == y || y < z) && (y = z)
        } else if (A = l ? this._castAsDate(A, e.dateFormat) : this._castAsNumber(A), isNaN(A) || A < v.min || A > v.max) f.push(NaN), g.push(void 0);
        else {
          var C = 0;
          ...
          } else !l || l && m ? (diffFromMin = A - j, C = (A - j) * w / u) : C = (A.valueOf() - j.valueOf()) / (k.valueOf() - j.valueOf()) * w;
          C = a.jqx._ptrnd(t.left + C), f.push(C), g.push(A), -1 == x && (x = z), (-1 == y || y < z) && (y = z)
        }
      }
      if (1 == e.flip)
        for (var z = 0; z < f.length; z++) isNaN(f[z]) || (f[z] = c - f[z]);
      (m || l) && (u = this._getDateDiff(j, k, e.baseUnit), u = a.jqx._rnd(u, 1, !1));
      var D = Math.max(1, u),
        E = w / D;
    ...
    _getSeriesColors: function(b, c, d) {
      ...
      if (this._isGreyScale(b, c))
        for (var f in e) e[f] = a.jqx.toGreyScale(e[f]);
      return e
    },
    _getColorFromScheme: function(a, b, c) {
      ...
      if (this._isPieGroup(a)) {
        ...
        if (e.colorScheme && (k = e.colorScheme, sidex = seriesIndex), void 0 != k && "" != k || (k = this.colorSchemes[0].name), !k) return d;
        for (var i = 0; i < this.colorSchemes.length; i++) {
          var l = this.colorSchemes[i];
          if (l.name == k) {
            for (; h > l.colors.length;) h -= l.colors.length, ++i >= this.colorSchemes.length && (i = 0), l = this.colorSchemes[i];
    ...
    _createColorsCache: function() {
      this._colorsCache = {
        get: function(a) {
          if (this._store[a]) return this._store[a]
        },
        set: function(a, b) {
          this._size < 1e4 && (this._store[a] = b, this._size++)
        },
        clear: function() {
    ...
    _getSeriesColorsInternal: function(b, c, d) {
      ...
      if (this._colorsCache.get(g)) return this._colorsCache.get(g);
      var h, i = {
        lineColor: "#222222",
      ...
      if (a.isFunction(f.colorFunction)) {
        ...
        if ("object" == typeof(h = f.colorFunction(j, d, f, e)))
          for (var k in h) i[k] = h[k];
        else i.fillColor = h
      } else {
        for (var k in i) f[k] && (i[k] = f[k]);
      ...
      for (var k in i) "object" == typeof h && h[k] || f[k] && (i[k] = f[k]);
      for (var k in i) "object" == typeof h && h[k] || f[k] || (i[k] = a.jqx.adjustColor(i[l[k].baseColor], l[k].adjust));
      return this._colorsCache.set(g, i), i
    },
    _getItemColorFromScheme: function(b, c, d, e) {
      ...
      for (var g = 0; g <= c;) {
        ...
        if (!(g + h <= c)) {
          ...
          return this._isGreyScale(d, e) && 0 == i.indexOf("#") && (i = a.jqx.toGreyScale(i)), i
        }
        g += h, f++
      }
    },
    getColorScheme: function(a) {
      for (var b = 0; b < this.colorSchemes.length; b++)
        if (this.colorSchemes[b].name == a) return this.colorSchemes[b].colors
    },
    addColorScheme: function(a, b) {
      for (var c = 0; c < this.colorSchemes.length; c++)
        if (this.colorSchemes[c].name == a) return void(this.colorSchemes[c].colors = b);
    ...
    _formatValue: function(b, c, d, e, f, g) {
      if (void 0 == b) return "";
      if (this._isObject(b) && !this._isDate(b) && !d) return "";
      if (d) {
        if (!a.isFunction(d)) return b.toString();
        try {
          return d(b, g, f, e)
        } catch (a) {
          return a.message
    ...
    _getFormattedValue: function(b, c, d, e, f, g) {
      var h = this.seriesGroups[b],
        ...
        k = e,
        l = f;
      l || (l = i.formatFunction || h.formatFunction), k || (k = i.formatSettings || h.formatSettings), !i.formatFunction && i.formatSettings && (l = void 0);
      var m = {},
        n = 0;
      for (var o in i) 0 == o.indexOf("dataField") && (m[o.substring(9).toLowerCase()] = this._getDataValue(d, i[o], b), n++);
      if (0 == n && (m = this._getDataValue(d, void 0, b)), -1 != h.type.indexOf("waterfall") && this._isSummary(b, d) && (m = this._renderData[b].offsets[c][d].value, n = 0), l && a.isFunction(l)) try {
        return l(1 == n ? m[""] : m, d, i, h)
      } catch (a) {
        return a.message
      }
      if (1 == n && this._isPieGroup(b)) return this._formatValue(m[""], k, l, b, c, d);
      if (n > 0) {
        var p = 0;
        for (var o in m) {
          p > 0 && "" != j && (j += "<br>");
          var q = "dataField" + (o.length > 0 ? o.substring(0, 1).toUpperCase() + o.substring(1) : ""),
            ...
            s = i[r] || i[q],
            t = m[o];
          void 0 != t && (t = this._formatValue(t, k, l, b, c, d), j += !0 === g ? t : s + ": " + t, p++)
        }
      } else void 0 != m && (j = this._formatValue(m, k, l, b, c, d));
      return j || ""
    },
    _isNumberAsString: function(b) {
      ...
      for (var c = 0; c < b.length; c++) {
        var d = b.charAt(c);
        if (!(d >= "0" && d <= "9" || "," == d || "." == d) && (("-" != d || 0 != c) && !("(" == d && 0 == c || ")" == d && c == b.length - 1))) return !1
      }
      return !0
    },
    _castAsDate: function(b, c) {
      if (b instanceof Date && !isNaN(b)) return b;
      if ("string" == typeof b) {
        var d;
        if (c && (d = a.jqx.dataFormat.parsedate(b, c), this._isDate(d))) return d;
        if (this._autoDateFormats)
          for (var e = 0; e < this._autoDateFormats.length; e++)
            if (d = a.jqx.dataFormat.parsedate(b, this._autoDateFormats[e]), this._isDate(d)) return d;
        var f = this._detectDateFormat(b);
        return f && (d = a.jqx.dataFormat.parsedate(b, f), this._isDate(d)) ? (this._autoDateFormats.push(f), d) : (d = new Date(b), this._isDate(d) && -1 == b.indexOf(":") && d.setHours(0, 0, 0, 0), d)
      }
    },
    _castAsNumber: function(a) {
      if (a instanceof Date && !isNaN(a)) return a.valueOf();
      if ("string" == typeof a)
        if (this._isNumber(a)) a = parseFloat(a);
    ...
    _isNumber: function(a) {
      return "string" == typeof a && this._isNumberAsString(a) && (a = parseFloat(a)), "number" == typeof a && isFinite(a)
    },
    _isDate: function(a) {
    ...
    _formatDate: function(b, c) {
      var d = b.toString();
      return c && (c.dateFormat && (d = a.jqx.dataFormat.formatDate(b, c.dateFormat)), d = (c.prefix || "") + d + (c.sufix || "")), d
    },
    _formatNumber: function(a, b) {
      if (!this._isNumber(a)) return a;
      b = b || {};
      var c = ".",
        d = "",
        e = this;
      e.localization && (c = e.localization.decimalSeparator || e.localization.decimalseparator || c, d = e.localization.thousandsSeparator || e.localization.thousandsseparator || d), b.decimalSeparator && (c = b.decimalSeparator), b.thousandsSeparator && (d = b.thousandsSeparator);
      var f = b.prefix || "",
        g = b.sufix || "",
        h = b.decimalPlaces;
      ...
      var k, l = a.toString(),
        m = Math.pow(10, h);
      if (l = (Math.round(a * m) / m).toString(), isNaN(l) && (l = ""), k = l.lastIndexOf("."), h > 0)
        for (k < 0 ? (l += c, k = l.length - 1) : "." !== c && (l = l.replace(".", c)); l.length - 1 - k < h;) l += "0";
      k = l.lastIndexOf(c), k = k > -1 ? k : l.length;
      for (var n = l.substring(k), o = 0, p = k; p > 0; p--, o++) o % 3 == 0 && p !== k && (!j || p > 1 || j && i) && (n = d + n), n = l.charAt(p - 1) + n;
      return l = n, j && i && (l = "(" + l + ")"), f + l + g
    },
    ...
    _getBezierPoints: function(b) {
      for (var c = "", d = [], e = [], f = b.split(" "), g = 0; g < f.length; g++) {
        var h = f[g].split(",");
        d.push(parseFloat(h[0])), d.push(parseFloat(h[1])), !isNaN(d[d.length - 1]) && isNaN(d[d.length - 2])
      }
      var i = d.length;
      if (i <= 1) return "";
      if (2 == i) return c = "M" + a.jqx._ptrnd(d[0]) + "," + a.jqx._ptrnd(d[1]) + " L" + a.jqx._ptrnd(d[0] + 1) + "," + a.jqx._ptrnd(d[1] + 1) + " ";
      for (var g = 0; g < i - 4; g += 2) e = e.concat(this._calculateControlPoints(d, g));
      for (var g = 2; g < i - 5; g += 2) c += " C" + a.jqx._ptrnd(e[2 * g - 2]) + "," + a.jqx._ptrnd(e[2 * g - 1]) + " " + a.jqx._ptrnd(e[2 * g]) + "," + a.jqx._ptrnd(e[2 * g + 1]) + " " + a.jqx._ptrnd(d[g + 2]) + "," + a.jqx._ptrnd(d[g + 3]) + " ";
      return c = i <= 4 || Math.abs(d[0] - d[2]) < 3 || Math.abs(d[1] - d[3]) < 3 || this._isVML ? "M" + a.jqx._ptrnd(d[0]) + "," + a.jqx._ptrnd(d[1]) + " L" + a.jqx._ptrnd(d[2]) + "," + a.jqx._ptrnd(d[3]) + " " + c : "M" + a.jqx._ptrnd(d[0]) + "," + a.jqx._ptrnd(d[1]) + " Q" + a.jqx._ptrnd(e[0]) + "," + a.jqx._ptrnd(e[1]) + " " + a.jqx._ptrnd(d[2]) + "," + a.jqx._ptrnd(d[3]) + " " + c, i >= 4 && (Math.abs(d[i - 2] - d[i - 4]) < 3 || Math.abs(d[i - 1] - d[i - 3]) < 3 || this._isVML) ? c += " L" + a.jqx._ptrnd(d[i - 2]) + "," + a.jqx._ptrnd(d[i - 1]) + " " : i >= 5 && (c += " Q" + a.jqx._ptrnd(e[2 * i - 10]) + "," + a.jqx._ptrnd(e[2 * i - 9]) + " " + a.jqx._ptrnd(d[i - 2]) + "," + a.jqx._ptrnd(d[i - 1]) + " "), c
    },
    _animTickInt: 50,
    _createAnimationGroup: function(a) {
      this._animGroups || (this._animGroups = {}), this._animGroups[a] = {
        animations: [],
        startTick: NaN
      }
    },
    _startAnimation: function(a) {
      var b = new Date,
        c = b.getTime();
      this._animGroups[a].startTick = c, this._runAnimation(), this._enableAnimTimer()
    },
    _enqueueAnimation: function(a, b, c, d, e, f, g) {
      d < 0 && (d = 0), void 0 == g && (g = "easeInOutSine"), this._animGroups[a].animations.push({
        key: b,
        properties: c,
        duration: d,
        fn: e,
    ...
    _runAnimation: function(b) {
      if (this._animGroups) {
        ...
        for (var f in this._animGroups) {
          for (var g = this._animGroups[f].animations, h = this._animGroups[f].startTick, i = 0, j = 0; j < g.length; j++) {
            ...
            var m = k.duration > 0 ? l / k.duration : 1,
              n = m;
            if (k.easing && 0 != k.duration && (n = a.easing[k.easing](m, l, 0, 1, k.duration)), m > 1 && (m = 1, n = 1), k.fn) k.fn(k.key, k.context, n);
            else {
              for (var o = {}, f = 0; f < k.properties.length; f++) {
                var p = k.properties[f],
                  q = 0;
                q = 1 == m ? p.to : easeParecent * (p.to - p.from) + p.from, o[p.key] = q
              }
        ...
        this._animGroups = e, this.renderer instanceof a.jqx.HTML5Renderer && this.renderer.refresh()
      }
    ...
    _fixCoords: function(a, b) {
      if ("horizontal" != this.seriesGroups[b].orientation) return a;
      var c = a.x;
      a.x = a.y, a.y = c + this._plotRect.y - this._plotRect.x;
      var c = a.width;
      return a.width = a.height, a.height = c, a
    },
    getItemCoord: function(a, b, c) {
      var d = this;
      if (d._isPieGroup(a) && (!d._isSerieVisible(a, b, c) || !d._renderData || d._renderData.length <= a)) return {
        x: NaN,
        y: NaN
      };
      if (!d._isSerieVisible(a, b) || !d._renderData || d._renderData.length <= a) return {
        x: NaN,
        y: NaN
      };
      ...
      if (d._isPieGroup(a)) {
        if (isNaN(g.x) || isNaN(g.y) || isNaN(g.fromAngle) || isNaN(g.toAngle)) return {
          x: NaN,
          y: NaN
        };
        ...
        x1 = h.x + g.center.x + Math.cos(i) * g.outerRadius, x2 = h.x + g.center.x + Math.cos(j) * g.outerRadius, y1 = h.y + g.center.y - Math.sin(i) * g.outerRadius, y2 = h.y + g.center.y - Math.sin(j) * g.outerRadius;
      ...
      if (-1 != e.type.indexOf("column") || -1 != e.type.indexOf("waterfall")) {
        ...
        g.height = Math.abs(g.y.to - g.y.from), g.y = Math.min(g.y.to, g.y.from), g.x += n.offset, g.width = n.width
        ...
        g.height = Math.abs(p - o), g.y = o, g.x += n.offset, g.width = n.width
      } else if (-1 != e.type.indexOf("line") || -1 != e.type.indexOf("area")) g.width = g.height = 0, g.y = g.y.to;
        ...
        var q = g.y.radius;
        "circle" != f.symbolType && void 0 != f.symbolType && (q /= 2), g.y = g.y.to, g.radius = q, g.width = 2 * q, g.height = 2 * q
      }
      if (g = this._fixCoords(g, a), e.polar || e.spider) {
        var r = this._toPolarCoord(this._renderData[a].polarCoords, this._plotRect, g.x, g.y);
        g.x = r.x, g.y = r.y, g.center && (g.center = this._toPolarCoord(this._renderData[a].polarCoords, this._plotRect, g.center.x, g.center.y))
      }
      return -1 == e.type.indexOf("bubble") && -1 == e.type.indexOf("scatter") || (g.x -= q, g.y -= q), g
    },
    _getItemCoord: function(a, b, c) {
      var d, e, f = this.seriesGroups[a];
      if (!f || !this._renderData) return {
        x: NaN,
        y: NaN
      };
      if (!f.series[b]) return {
        x: NaN,
        y: NaN
      };
      ...
      if (this._isPieGroup(a)) {
        ...
        return d = g.x + h.x + Math.cos(i) * h.outerRadius, e = g.y + h.y - Math.sin(i) * h.outerRadius, {
          x: d,
          y: e,
          center: {
            x: h.x,
      ...
      if (d = g.x + this._renderData[a].xoffsets.data[c], e = this._renderData[a].offsets[b][c], isNaN(d) || !e) return {
        x: NaN,
        y: NaN
      };
      var j = {};
    ...
    getValueAxisValue: function(b, c) {
      ...
      if (d) {
        ...
        if (d.polar || d.spider) {
          ...
          h = a.jqx._ptdist(b.x, b.y, i.x, i.y), g = i.r, h = g - h
    ...
    _detectDateFormat: function(b, c) {
      ...
      for (var g = 0; g < e.length; g++)
        if (value = e[g], null != value && void 0 != value)
          for (var f in d) {
      ...
      for (var f in d) d[f].count > i.count && (i.key = f, i.count = d[f].count);
    ...
    _testXAxisDateFormat: function(a) {
      ...
      if (b.localization && b.localization.patterns)
        for (var f in b.localization.patterns) e["local_" + f] = b.localization.patterns[f];
      for (var g = [], h = 0; h < d && h < 10; h++) value = b._getDataValue(h, c.dataField, a), null != value && void 0 != value && g.push(value);
